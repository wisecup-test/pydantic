...
- **R-PYTEST-001** MAY: Tests MAY use pytest plugins for additional functionality such as coverage reporting or benchmark testing.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of pytest adoption and test file naming conventions.
</enforcement>
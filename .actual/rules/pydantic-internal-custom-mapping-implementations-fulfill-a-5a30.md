...
- **R-MAP-001** MUST: Custom mapping implementations MUST fulfill all abstract methods of the collections.abc.Mapping protocol, including item lookup, length calculation, container membership testing, and iteration.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. Automated static type analysis and unit test suites validate dictionary contract compliance and priority resolution ordering.
</enforcement>
# Adopt pytest as Standard Testing Framework: Tests Use Pytest
...
- **R-PYTEST-001** SHOULD: Tests SHOULD use pytest fixtures for setup and teardown operations rather than class-based setUp/tearDown methods.
...
- Tests use pytest fixtures for setup and teardown instead of class-based setUp/tearDown methods

<enforcement>
Claude Code MUST NOT skip or defer verification of pytest adoption and fixture usage patterns.
</enforcement>
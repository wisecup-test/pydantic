# Adopt Integration Testing Strategy with Core Metadata Validation: Documentation Generation Tools
...
- **R-INT-001** SHOULD: Documentation generation tools and plugins SHOULD include integration tests to verify correct interaction with the main codebase.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of integration test presence and coverage for modules handling metadata, configuration, or cross-module interactions.
</enforcement>
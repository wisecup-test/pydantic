# Standardize Structured Logging with Contextual Information: Logging Implementations Use
...
- **R-LOG-001** MUST: Logging implementations MUST use appropriate log levels (DEBUG, INFO, WARNING, ERROR, CRITICAL) based on the severity and nature of the event.
...
# Identify logging calls in Python files with line numbers
...
<enforcement>
Claude Code MUST NOT skip or defer verification. Violations of R-LOG-001 block merge in CI/CD pipelines for critical violations (sensitive data logging). Code review feedback is required for missing context or inappropriate log levels before approval.
</enforcement>
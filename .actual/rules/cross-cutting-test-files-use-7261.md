# Adopt pytest as Standard Testing Framework: Test Files Use
...
- **R-PYTEST-001** MUST: All test files MUST use pytest as the testing framework and follow pytest conventions.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All test files must be validated against pytest conventions before acceptance.
</enforcement>
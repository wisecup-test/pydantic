# Standardize Structured Logging with Contextual Information: Log Messages Include
...
- **R-LOG-001** SHOULD: Log messages SHOULD include identifiers (request IDs, user IDs, resource IDs) that enable correlation across distributed components.

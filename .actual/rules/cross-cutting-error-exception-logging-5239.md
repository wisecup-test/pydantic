# Standardize Structured Logging with Contextual Information: Error Exception Logging
...
- **R-LOG-001** SHOULD: Error and exception logging SHOULD capture stack traces and relevant state information to facilitate debugging.

...
|---|---|
| `pydantic-core/src/**` | `pydantic-core-` _(114 ADRs)_ |
| `pydantic/**` | `pydantic-` _(41 ADRs)_ |
| `pydantic-core/**/*` + `pydantic/**/*` + `tests/**/*`<br>`./**/*` + `.github/**/*` + `pydantic-core/**/*`<br>`./**/*` + `pydantic/**/*` + `tests/**/*`<br>`**/*` | `cross-cutting-` _(34 ADRs)_ |
| `.github/actions/people/**` | `github-actions-people-` _(31 ADRs)_ |
| `pydantic/v1/**` | `pydantic-v1-` _(20 ADRs)_ |
| `pydantic-core/src/serializers/**` | `pydantic-core-serializers-` _(17 ADRs)_ |
| `pydantic/_internal/**` | `pydantic-internal-` _(17 ADRs)_ |
| `pydantic-core/src/input/**` | `pydantic-core-input-` _(15 ADRs)_ |
| `pydantic-core/wasm-preview/**` | `pydantic-core-wasm-preview-` _(9 ADRs)_ |
| `pydantic-core/src/serializers/type_serializers/**` | `pydantic-core-serializers-type-serializers-` _(6 ADRs)_ |
| `docs/plugins/**` | `docs-plugins-` _(6 ADRs)_ |
| `docs/extra/**` | `docs-extra-` _(4 ADRs)_ |

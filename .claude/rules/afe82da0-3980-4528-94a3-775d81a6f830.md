<rule_activation id="afe82da0-3980-4528-94a3-775d81a6f830" title="Establish Pydantic as Standard Data Validation and Configuration Framework: Configuration Objects Defined" applies_to="**/*">
...
- **R-PYDANTIC-001** MUST: Configuration objects MUST be defined as Pydantic BaseModel subclasses with explicit field types and validation rules.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of Pydantic BaseModel usage at API boundaries and configuration objects. All new external interfaces MUST use Pydantic validation unless an approved exception is documented.
</enforcement>
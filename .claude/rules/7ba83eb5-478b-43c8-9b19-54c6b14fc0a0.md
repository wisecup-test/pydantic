<rule_activation id="7ba83eb5-478b-43c8-9b19-54c6b14fc0a0" title="Adopt pytest as Standard Testing Framework for Python Projects: Complex Test Scenarios" applies_to="tests/**/*.py">
These rules are ALWAYS ACTIVE for all Python test files in the tests/ directory.
</rule_activation>

### Rules

- **R-PYTEST-001** SHOULD: Complex test scenarios SHOULD use pytest.mark.parametrize for data-driven testing to reduce code duplication.

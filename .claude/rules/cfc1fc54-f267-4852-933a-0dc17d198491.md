<rule_activation id="cfc1fc54-f267-4852-933a-0dc17d198491" title="Enforce Type Safety and Validation in Public API Contracts: Public Models Include" applies_to="**/*">
...
- **R-API-001** MUST: All public API models MUST include comprehensive test coverage for type validation, including edge cases, invalid inputs, and boundary conditions.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All public API models MUST be validated against these rules before code is committed. Violations block merge and require remediation or approved exception.
</enforcement>
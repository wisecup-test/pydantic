<rule_activation id="1ad699c1-0757-4826-a1bb-b5578602a33d" title="Enforce Domain Validation in Public API Models: Domain Validation Rules" applies_to="**/*">
These rules are ALWAYS ACTIVE for all public/external API endpoints and data models exposed to external consumers.
</rule_activation>

### Rules

- **R-DV-001** SHOULD: Domain validation rules SHOULD be co-located with model definitions to maintain clear ownership and discoverability.

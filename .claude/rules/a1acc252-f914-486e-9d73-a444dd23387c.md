<rule_activation id="a1acc252-f914-486e-9d73-a444dd23387c" title="Enforce Type Safety and Validation in Public API Contracts: Public Not Accept" applies_to="**/*">
...
- **R-API-001** MUST_NOT: Public APIs MUST NOT accept unvalidated or loosely-typed inputs (e.g., Any, dict without schema) from external sources.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All public API contracts MUST be validated against these rules before acceptance. Violations block merge and require remediation or documented exception approval.
</enforcement>
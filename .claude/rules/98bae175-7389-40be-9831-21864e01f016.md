<rule_activation id="98bae175-7389-40be-9831-21864e01f016" title="Enforce Type Safety and Validation in Public API Contracts: Contracts Support Json" applies_to="**/*">
...
- **R-API-001** SHOULD: API contracts SHOULD support JSON serialization and deserialization with proper handling of complex types (datetime, timezone, enums).

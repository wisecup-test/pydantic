<rule_activation id="c6f179d7-cf8d-48b5-85ba-c49e1266a2bc" title="Adopt Type Annotation and Runtime Validation for Public API Interfaces: Internal Implementation Details" applies_to="**/*">
...
- **R-API-001** MAY: Internal implementation details MAY use less strict type annotations if they are not exposed through public interfaces.
...
<enforcement>
Claude Code MUST verify type annotations and runtime validation compliance before accepting changes to public API interfaces. Verification is mandatory and cannot be deferred.
</enforcement>
<rule_activation id="ced71551-1da2-4c97-aea0-0ee419947523" title="Enforce Domain Validation in Public API Models: Models Implement Custom" applies_to="**/*">
These rules are ALWAYS ACTIVE for all public/external API endpoints and data models exposed to external consumers.
</rule_activation>

### Rules

- **R-API-001** MAY: API models MAY implement custom validators for complex business rules that cannot be expressed through type annotations alone.

<rule_activation id="8ba996fd-48ba-485b-8a3e-dec909abdf5a" title="Enforce Type Safety and Validation in Public API Contracts: Type Validation Errors" applies_to="**/*">
...
- **R-TYPE-001** MUST: Type validation errors MUST provide clear, actionable error messages that specify the field name, expected type, and received value.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. Type validation errors MUST be verified before accepting code changes to public API contracts.
</enforcement>
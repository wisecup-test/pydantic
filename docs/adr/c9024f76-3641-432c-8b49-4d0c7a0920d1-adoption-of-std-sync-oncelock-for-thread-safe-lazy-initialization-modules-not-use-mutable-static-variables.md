...
1. MUST_NOT: Modules MUST NOT use mutable static variables or unsafe memory blocks to achieve lazy or once-only global initialization.

## Policy Block

- MUST_NOT Modules MUST NOT use mutable static variables or unsafe memory blocks to achieve lazy or once-only global initialization.

...
1. SHOULD: Compatibility model configurations within the internal namespace SHOULD subclass BaseConfig or CustomConfig while explicitly defining extra field handling behaviors.

## Policy Block

- SHOULD Compatibility model configurations within the internal namespace SHOULD subclass BaseConfig or CustomConfig while explicitly defining extra field handling behaviors.

...
1. MUST: Configuration and schema transformation callables MUST adhere to the SchemaExtraCallable protocol or ConfigDict structure defined in the centralized typing and configuration modules.

## Policy Block

- MUST Configuration and schema transformation callables MUST adhere to the SchemaExtraCallable protocol or ConfigDict structure defined in the centralized typing and configuration modules.

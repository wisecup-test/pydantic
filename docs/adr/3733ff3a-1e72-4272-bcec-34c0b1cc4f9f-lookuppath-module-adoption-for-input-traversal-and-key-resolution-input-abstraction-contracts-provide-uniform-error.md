...
1. SHOULD: Input abstraction contracts SHOULD provide uniform error propagation when a LookupPath lookup yields missing or inaccessible targets.

## Policy Block

- SHOULD Input abstraction contracts SHOULD provide uniform error propagation when a LookupPath lookup yields missing or inaccessible targets.

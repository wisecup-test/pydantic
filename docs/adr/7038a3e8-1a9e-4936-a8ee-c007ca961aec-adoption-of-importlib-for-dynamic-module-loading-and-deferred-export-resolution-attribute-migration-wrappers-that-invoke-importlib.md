...
1. SHOULD: Attribute migration wrappers that invoke importlib SHOULD trigger deprecation warnings when resolving legacy or relocated public attributes.

## Policy Block

- SHOULD Attribute migration wrappers that invoke importlib SHOULD trigger deprecation warnings when resolving legacy or relocated public attributes.

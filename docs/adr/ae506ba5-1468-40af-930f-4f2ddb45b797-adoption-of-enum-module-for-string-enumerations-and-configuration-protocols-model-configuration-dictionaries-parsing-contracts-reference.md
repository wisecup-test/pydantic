...
1. MUST: Model configuration dictionaries and parsing contracts MUST reference Enum member types rather than unconstrained string types for categorical option fields.

## Policy Block

- MUST Model configuration dictionaries and parsing contracts MUST reference Enum member types rather than unconstrained string types for categorical option fields.

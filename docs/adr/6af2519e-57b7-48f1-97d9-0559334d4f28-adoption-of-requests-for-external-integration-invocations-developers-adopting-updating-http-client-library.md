...
1. MUST: Developers adopting or updating the HTTP client library MUST inspect the repository lock artifact to determine the exact resolved dependency version prior to implementation.

## Policy Block

- MUST Developers adopting or updating the HTTP client library MUST inspect the repository lock artifact to determine the exact resolved dependency version prior to implementation.

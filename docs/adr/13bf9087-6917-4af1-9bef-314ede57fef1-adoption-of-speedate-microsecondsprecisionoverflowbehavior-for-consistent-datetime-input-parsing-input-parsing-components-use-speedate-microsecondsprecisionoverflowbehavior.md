...
1. MUST: Input parsing components MUST use speedate::MicrosecondsPrecisionOverflowBehavior to configure and enforce consistent datetime sub-second precision overflow semantics across all payload parsing boundaries.

## Policy Block

- MUST Input parsing components MUST use speedate::MicrosecondsPrecisionOverflowBehavior to configure and enforce consistent datetime sub-second precision overflow semantics across all payload parsing boundaries.

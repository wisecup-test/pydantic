...
1. SHOULD: API documentation SHOULD explicitly note that set/frozenset types are serialized as arrays and order is not guaranteed

## Policy Block

- SHOULD API documentation SHOULD explicitly note that set/frozenset types are serialized as arrays and order is not guaranteed

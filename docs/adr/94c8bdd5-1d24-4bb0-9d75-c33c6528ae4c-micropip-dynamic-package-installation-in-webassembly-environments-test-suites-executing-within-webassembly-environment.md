...
1. MUST_NOT: Test suites executing within the WebAssembly environment MUST NOT attempt out-of-process isolation or background thread spawning when executing in single-threaded environments.

## Policy Block

- MUST_NOT Test suites executing within the WebAssembly environment MUST NOT attempt out-of-process isolation or background thread spawning when executing in single-threaded environments.

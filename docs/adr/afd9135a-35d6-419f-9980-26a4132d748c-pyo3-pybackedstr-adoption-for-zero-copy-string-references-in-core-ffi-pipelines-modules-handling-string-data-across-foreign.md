...
1. MUST: Modules handling string data across the foreign function interface boundary MUST adopt pyo3::pybacked::PyBackedStr to retain references to foreign string buffers without performing eager byte-copying heap allocations.

## Policy Block

- MUST Modules handling string data across the foreign function interface boundary MUST adopt pyo3::pybacked::PyBackedStr to retain references to foreign string buffers without performing eager byte-copying heap allocations.

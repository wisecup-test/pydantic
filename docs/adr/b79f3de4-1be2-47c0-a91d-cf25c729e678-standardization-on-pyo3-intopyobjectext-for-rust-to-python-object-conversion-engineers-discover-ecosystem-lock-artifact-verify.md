...
1. MUST: Engineers MUST discover the ecosystem lock artifact and verify the exact resolved version of the foreign function interface library before writing or updating object conversion implementations.

## Policy Block

- MUST Engineers MUST discover the ecosystem lock artifact and verify the exact resolved version of the foreign function interface library before writing or updating object conversion implementations.

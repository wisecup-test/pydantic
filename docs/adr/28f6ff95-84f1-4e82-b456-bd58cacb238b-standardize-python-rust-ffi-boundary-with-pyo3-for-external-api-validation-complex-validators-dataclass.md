# Standardize Python-Rust FFI Boundary with PyO3 for External API Validation: Complex Validators Dataclass
...
1. SHOULD: Complex validators (dataclass, callable, URL, timedelta, UUID) SHOULD implement consistent error handling patterns with PyErr conversion

## Policy Block

- SHOULD Complex validators (dataclass, callable, URL, timedelta, UUID) SHOULD implement consistent error handling patterns with PyErr conversion

...
1. MUST: Developers MUST inspect the repository dependency resolution lock artifact to identify the exact locked version of PyO3 and confirm API compatibility before introducing or modifying PyO3 interfaces.

## Policy Block

- MUST Developers MUST inspect the repository dependency resolution lock artifact to identify the exact locked version of PyO3 and confirm API compatibility before introducing or modifying PyO3 interfaces.

...
1. MUST: All core library subsystems requiring type introspection, protocol definitions, or runtime type shims MUST import shared typing abstractions from pydantic.v1.typing rather than defining local compatibility constructs.

## Policy Block

- MUST All core library subsystems requiring type introspection, protocol definitions, or runtime type shims MUST import shared typing abstractions from pydantic.v1.typing rather than defining local compatibility constructs.

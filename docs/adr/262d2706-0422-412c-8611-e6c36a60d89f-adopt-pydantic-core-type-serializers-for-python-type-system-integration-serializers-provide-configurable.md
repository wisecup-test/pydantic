...
1. SHOULD: Serializers SHOULD provide configurable behavior through serialization context to handle format-specific requirements

## Policy Block

- SHOULD Serializers SHOULD provide configurable behavior through serialization context to handle format-specific requirements

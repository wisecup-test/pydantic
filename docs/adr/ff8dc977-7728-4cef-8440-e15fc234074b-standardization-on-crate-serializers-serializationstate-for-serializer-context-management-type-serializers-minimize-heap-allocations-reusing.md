...
1. SHOULD: Type serializers SHOULD minimize heap allocations by reusing borrows and shared structures within crate::serializers::SerializationState rather than duplicating context data.

## Policy Block

- SHOULD Type serializers SHOULD minimize heap allocations by reusing borrows and shared structures within crate::serializers::SerializationState rather than duplicating context data.

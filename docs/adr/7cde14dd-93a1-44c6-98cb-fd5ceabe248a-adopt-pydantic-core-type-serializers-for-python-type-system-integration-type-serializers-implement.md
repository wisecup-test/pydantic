...
1. MAY: Type serializers MAY implement custom error handling for invalid or unsupported type conversions

## Policy Block

- MAY Type serializers MAY implement custom error handling for invalid or unsupported type conversions

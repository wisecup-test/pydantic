# Adopt pytest as Standard Testing Framework for Python Projects: Pipelines Execute Pytest
...
1. MUST: CI/CD pipelines MUST execute pytest as the primary test runner for all Python test suites

## Policy Block

- MUST CI/CD pipelines MUST execute pytest as the primary test runner for all Python test suites

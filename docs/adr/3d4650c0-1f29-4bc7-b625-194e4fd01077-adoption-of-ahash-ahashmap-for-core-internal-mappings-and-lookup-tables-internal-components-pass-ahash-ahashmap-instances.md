...
1. SHOULD: Internal components SHOULD pass ahash::AHashMap instances across internal module boundaries whenever shared lookup state or cached field metadata is transferred between validation and serialization layers.

## Policy Block

- SHOULD Internal components SHOULD pass ahash::AHashMap instances across internal module boundaries whenever shared lookup state or cached field metadata is transferred between validation and serialization layers.

# Adopt Runtime Configuration Sources for Plugin and Extension Systems: Public Plugin Extension
...
1. MUST: Public APIs with plugin or extension systems MUST support runtime configuration sources that can be loaded without modifying source code

## Policy Block

- MUST Public APIs with plugin or extension systems MUST support runtime configuration sources that can be loaded without modifying source code

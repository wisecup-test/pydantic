...
1. MUST: Categorical options, configuration states, and protocol identifiers MUST be defined as enumeration classes inheriting from both the primitive string type and Enum.

## Policy Block

- MUST Categorical options, configuration states, and protocol identifiers MUST be defined as enumeration classes inheriting from both the primitive string type and Enum.

# Adopt Environment Variable-Based Secret Management for External API Integration: External Credentials Keys
...
1. MUST: All external API credentials (API keys, tokens, secrets) MUST be stored as environment variables and MUST NOT be hardcoded in source code

## Policy Block

- MUST All external API credentials (API keys, tokens, secrets) MUST be stored as environment variables and MUST NOT be hardcoded in source code

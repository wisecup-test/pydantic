...
1. MUST_NOT: Internal conversion contracts that are logically incapable of failing MUST NOT introduce custom uninhabited error types or wrap results in fallible domain error enums.

## Policy Block

- MUST_NOT Internal conversion contracts that are logically incapable of failing MUST NOT introduce custom uninhabited error types or wrap results in fallible domain error enums.

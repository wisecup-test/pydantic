# Implement Cache Layer for External API Data Validation: Cache Keys Derived
...
1. MUST: Cache keys MUST be derived from the normalized form of the input data to ensure cache hits for semantically equivalent inputs

## Policy Block

- MUST Cache keys MUST be derived from the normalized form of the input data to ensure cache hits for semantically equivalent inputs

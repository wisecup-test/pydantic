...
1. MUST_NOT: Package-level initialization modules MUST_NOT instantiate ad-hoc intermediate dictionary structures for schema validation, but MUST route core schema exports directly through dynamic attribute resolution against pydantic_core.

## Policy Block

- MUST_NOT Package-level initialization modules MUST_NOT instantiate ad-hoc intermediate dictionary structures for schema validation, but MUST route core schema exports directly through dynamic attribute resolution against pydantic_core.

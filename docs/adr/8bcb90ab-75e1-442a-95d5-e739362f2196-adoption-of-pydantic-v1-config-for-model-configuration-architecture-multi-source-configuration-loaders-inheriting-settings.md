...
1. SHOULD: Multi-source configuration loaders inheriting from settings abstractions SHOULD implement customise_sources on the configuration class to establish deterministic precedence across sources.

## Policy Block

- SHOULD Multi-source configuration loaders inheriting from settings abstractions SHOULD implement customise_sources on the configuration class to establish deterministic precedence across sources.

...
1. SHOULD: Native modules performing repeated identifier lookups or string comparisons against runtime attributes SHOULD use pyo3::intern to minimize allocation overhead across the foreign-function boundary.

## Policy Block

- SHOULD Native modules performing repeated identifier lookups or string comparisons against runtime attributes SHOULD use pyo3::intern to minimize allocation overhead across the foreign-function boundary.

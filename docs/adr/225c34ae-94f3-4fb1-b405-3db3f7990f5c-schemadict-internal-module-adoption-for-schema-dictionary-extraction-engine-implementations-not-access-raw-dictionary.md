...
1. MUST_NOT: Engine implementations MUST NOT access raw dictionary keys directly when constructing validator or serializer components from schema definitions.

## Policy Block

- MUST_NOT Engine implementations MUST NOT access raw dictionary keys directly when constructing validator or serializer components from schema definitions.

...
1. MUST_NOT: Data modeling structures MUST NOT implement custom manual serialization routines when standard derive attributes provide equivalent behavior.

## Policy Block

- MUST_NOT Data modeling structures MUST NOT implement custom manual serialization routines when standard derive attributes provide equivalent behavior.

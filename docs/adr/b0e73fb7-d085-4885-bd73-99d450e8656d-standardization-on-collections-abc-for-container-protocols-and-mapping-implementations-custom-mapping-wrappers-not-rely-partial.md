...
1. MUST_NOT: Custom mapping wrappers MUST NOT rely on partial ad-hoc dictionary methods without implementing the standard collections.abc abstract interface methods.

## Policy Block

- MUST_NOT Custom mapping wrappers MUST NOT rely on partial ad-hoc dictionary methods without implementing the standard collections.abc abstract interface methods.

# Adopt Pydantic V1 Compatibility Layer for Type Validation: Projects Use Typeadapter
...
1. MAY: Projects MAY use TypeAdapter for dynamic type validation when model classes are not appropriate

## Policy Block

- MAY Projects MAY use TypeAdapter for dynamic type validation when model classes are not appropriate

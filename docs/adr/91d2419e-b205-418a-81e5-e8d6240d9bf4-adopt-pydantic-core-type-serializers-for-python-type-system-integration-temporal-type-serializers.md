...
1. MUST: Temporal type serializers (timedelta) MUST handle precision requirements and provide both numeric and ISO 8601 string format outputs

## Policy Block

- MUST Temporal type serializers (timedelta) MUST handle precision requirements and provide both numeric and ISO 8601 string format outputs

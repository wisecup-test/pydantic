...
1. MUST_NOT: Modules MUST NOT implement manual string-matching dispatch blocks to retrieve variant descriptions when an enumeration is annotated with strum::EnumMessage.

## Policy Block

- MUST_NOT Modules MUST NOT implement manual string-matching dispatch blocks to retrieve variant descriptions when an enumeration is annotated with strum::EnumMessage.

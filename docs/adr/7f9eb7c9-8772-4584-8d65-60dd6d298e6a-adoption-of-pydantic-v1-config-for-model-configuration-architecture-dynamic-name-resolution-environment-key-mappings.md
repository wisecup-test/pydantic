...
1. SHOULD: Dynamic name resolution and environment key mappings SHOULD be resolved through prepare_field on the model configuration class rather than at instantiation time.

## Policy Block

- SHOULD Dynamic name resolution and environment key mappings SHOULD be resolved through prepare_field on the model configuration class rather than at instantiation time.

...
1. SHOULD: Modules handling serialization SHOULD support extracting the string value directly from Enum instances or through configuration settings enabling enum value extraction.

## Policy Block

- SHOULD Modules handling serialization SHOULD support extracting the string value directly from Enum instances or through configuration settings enabling enum value extraction.

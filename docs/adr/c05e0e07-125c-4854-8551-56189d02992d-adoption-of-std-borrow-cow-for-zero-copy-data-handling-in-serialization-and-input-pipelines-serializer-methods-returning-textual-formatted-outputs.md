...
1. MUST: Serializer methods returning textual or formatted outputs MUST return Cow::Borrowed when the underlying representation can be directly referenced from the source input.

## Policy Block

- MUST Serializer methods returning textual or formatted outputs MUST return Cow::Borrowed when the underlying representation can be directly referenced from the source input.

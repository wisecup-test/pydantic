# Standardize Unit Testing Patterns for Public API Validation: Error Messages Types
...
1. MUST: Error messages and error types returned by public APIs MUST be validated in unit tests to ensure consistent error contracts

## Policy Block

- MUST Error messages and error types returned by public APIs MUST be validated in unit tests to ensure consistent error contracts

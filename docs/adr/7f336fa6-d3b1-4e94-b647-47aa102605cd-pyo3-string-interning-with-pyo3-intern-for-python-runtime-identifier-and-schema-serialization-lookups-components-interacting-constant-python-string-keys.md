...
1. MUST: Components interacting with constant Python string keys, attribute names, or runtime sentinels MUST obtain Python string references using pyo3::intern rather than dynamic string allocation routines.

## Policy Block

- MUST Components interacting with constant Python string keys, attribute names, or runtime sentinels MUST obtain Python string references using pyo3::intern rather than dynamic string allocation routines.

...
1. SHOULD: Modules defining custom type serialization builders SHOULD share interned identifier lookups across repeated serialization passes to maximize lookup performance.

## Policy Block

- SHOULD Modules defining custom type serialization builders SHOULD share interned identifier lookups across repeated serialization passes to maximize lookup performance.

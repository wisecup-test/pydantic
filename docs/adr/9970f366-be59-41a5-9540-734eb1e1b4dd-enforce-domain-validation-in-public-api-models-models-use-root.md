# Enforce Domain Validation in Public API Models: Models Use Root
...
1. SHOULD: API models SHOULD use root models or base model inheritance to ensure consistent validation behavior across all endpoints

## Policy Block

- SHOULD API models SHOULD use root models or base model inheritance to ensure consistent validation behavior across all endpoints

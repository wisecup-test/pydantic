...
1. MUST: Reusable build and packaging actions for submodules MUST be located within the root .github/actions/ directory hierarchy.

## Policy Block

- MUST Reusable build and packaging actions for submodules MUST be located within the root .github/actions/ directory hierarchy.

...
1. SHOULD: Shared static state and lazily evaluated host references SHOULD use pyo3::sync::PyOnceLock to ensure thread-safe initialization under host runtime threading constraints.

## Policy Block

- SHOULD Shared static state and lazily evaluated host references SHOULD use pyo3::sync::PyOnceLock to ensure thread-safe initialization under host runtime threading constraints.

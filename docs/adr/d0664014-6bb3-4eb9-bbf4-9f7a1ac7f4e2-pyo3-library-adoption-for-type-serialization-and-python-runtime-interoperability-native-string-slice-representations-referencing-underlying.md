...
1. SHOULD: Native string slice representations referencing underlying Python string memory SHOULD use pyo3::pybacked::PyBackedStr to avoid redundant string copying across the runtime boundary.

## Policy Block

- SHOULD Native string slice representations referencing underlying Python string memory SHOULD use pyo3::pybacked::PyBackedStr to avoid redundant string copying across the runtime boundary.

...
1. MUST: Components requiring lazy, one-time static initialization of runtime objects MUST use pyo3::sync::PyOnceLock rather than uncoordinated static mutables or foreign synchronization primitives.

## Policy Block

- MUST Components requiring lazy, one-time static initialization of runtime objects MUST use pyo3::sync::PyOnceLock rather than uncoordinated static mutables or foreign synchronization primitives.

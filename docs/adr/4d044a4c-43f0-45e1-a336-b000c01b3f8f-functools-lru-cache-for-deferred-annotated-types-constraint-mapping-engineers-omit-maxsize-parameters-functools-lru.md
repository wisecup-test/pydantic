...
1. MAY: Engineers MAY omit maxsize parameters on functools.lru_cache decorators when memoizing static, parameterless mapping functions.

## Policy Block

- MAY Engineers MAY omit maxsize parameters on functools.lru_cache decorators when memoizing static, parameterless mapping functions.

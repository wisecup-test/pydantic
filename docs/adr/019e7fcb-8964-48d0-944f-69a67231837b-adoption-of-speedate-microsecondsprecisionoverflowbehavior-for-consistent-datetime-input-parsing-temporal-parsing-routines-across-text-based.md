...
1. MUST: Temporal parsing routines across text-based and structured object inputs MUST standardize on a unified precision overflow configuration rather than implementing independent or divergent parsing heuristics.

## Policy Block

- MUST Temporal parsing routines across text-based and structured object inputs MUST standardize on a unified precision overflow configuration rather than implementing independent or divergent parsing heuristics.

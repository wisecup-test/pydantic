...
1. MAY: Specialized datetime or network components MAY expose parse_date, parse_time, or parse_datetime helper routines to normalize raw textual inputs prior to model construction.

## Policy Block

- MAY Specialized datetime or network components MAY expose parse_date, parse_time, or parse_datetime helper routines to normalize raw textual inputs prior to model construction.

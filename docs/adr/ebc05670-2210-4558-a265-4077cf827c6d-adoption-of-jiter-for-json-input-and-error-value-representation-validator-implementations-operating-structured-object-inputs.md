...
1. SHOULD: Validator implementations operating on structured object inputs SHOULD traverse fields directly via jiter::JsonObject accessor interfaces rather than allocating intermediate associative maps.

## Policy Block

- SHOULD Validator implementations operating on structured object inputs SHOULD traverse fields directly via jiter::JsonObject accessor interfaces rather than allocating intermediate associative maps.

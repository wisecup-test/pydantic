...
1. MUST: Serializers holding native references to runtime Python objects that participate in cyclic reference graphs MUST implement garbage collection traversal using pyo3::gc::PyVisit and return pyo3::PyTraverseError upon traversal failure.

## Policy Block

- MUST Serializers holding native references to runtime Python objects that participate in cyclic reference graphs MUST implement garbage collection traversal using pyo3::gc::PyVisit and return pyo3::PyTraverseError upon traversal failure.

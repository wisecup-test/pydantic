...
1. MUST_NOT: Serializer implementations MUST NOT unconditionally clone incoming string or slice data when the lifetime of the input argument permits a borrowed reference.

## Policy Block

- MUST_NOT Serializer implementations MUST NOT unconditionally clone incoming string or slice data when the lifetime of the input argument permits a borrowed reference.

...
1. MUST: Models and specialized validation classes MUST declare execution rules and ingestion behaviors through an inner Config class inheriting from BaseConfig defined in pydantic.v1.config.

## Policy Block

- MUST Models and specialized validation classes MUST declare execution rules and ingestion behaviors through an inner Config class inheriting from BaseConfig defined in pydantic.v1.config.

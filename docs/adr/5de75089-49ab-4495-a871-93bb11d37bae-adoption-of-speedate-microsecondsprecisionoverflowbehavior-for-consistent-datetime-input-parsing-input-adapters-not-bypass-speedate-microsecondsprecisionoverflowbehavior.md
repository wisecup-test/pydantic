...
1. MUST_NOT: Input adapters MUST NOT bypass speedate::MicrosecondsPrecisionOverflowBehavior when delegating timestamp extraction from scalar strings or serialized payload fields.

## Policy Block

- MUST_NOT Input adapters MUST NOT bypass speedate::MicrosecondsPrecisionOverflowBehavior when delegating timestamp extraction from scalar strings or serialized payload fields.

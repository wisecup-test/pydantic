...
1. MUST: Native serializers handling structured mapping data MUST interface directly through pyo3::types::PyDict to construct and extract key-value pairs without intermediate serialization layers.

## Policy Block

- MUST Native serializers handling structured mapping data MUST interface directly through pyo3::types::PyDict to construct and extract key-value pairs without intermediate serialization layers.

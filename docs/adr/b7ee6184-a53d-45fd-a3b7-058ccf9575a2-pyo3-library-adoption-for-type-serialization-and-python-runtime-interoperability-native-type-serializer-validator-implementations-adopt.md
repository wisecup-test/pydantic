...
1. MUST: Native type serializer and validator implementations MUST adopt the PyO3 library for foreign function interface interoperability and Python runtime type bindings.

## Policy Block

- MUST Native type serializer and validator implementations MUST adopt the PyO3 library for foreign function interface interoperability and Python runtime type bindings.

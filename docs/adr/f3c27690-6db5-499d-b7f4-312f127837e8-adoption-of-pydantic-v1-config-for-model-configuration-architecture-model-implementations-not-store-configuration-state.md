...
1. MUST_NOT: Model implementations MUST_NOT store configuration state as instance attributes on the validated data structures.

## Policy Block

- MUST_NOT Model implementations MUST_NOT store configuration state as instance attributes on the validated data structures.

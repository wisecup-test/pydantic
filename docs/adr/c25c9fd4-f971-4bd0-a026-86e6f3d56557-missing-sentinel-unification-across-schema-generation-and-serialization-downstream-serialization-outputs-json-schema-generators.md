...
1. MUST_NOT: Downstream serialization outputs and JSON schema generators MUST NOT leak the internal MISSING sentinel object into user-facing output payloads or exported schemas.

## Policy Block

- MUST_NOT Downstream serialization outputs and JSON schema generators MUST NOT leak the internal MISSING sentinel object into user-facing output payloads or exported schemas.

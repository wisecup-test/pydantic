# Enforce Domain Validation in Public API Models: Models Type Checked
...
1. MUST: All API models MUST be type-checked using static analysis tools (mypy, pyright) as part of the CI/CD pipeline

## Policy Block

- MUST All API models MUST be type-checked using static analysis tools (mypy, pyright) as part of the CI/CD pipeline

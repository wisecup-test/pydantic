# Adopt pytest as Standard Testing Framework for Python Projects: Test Files Organized
...
1. MUST: Test files MUST be organized in a dedicated tests/ directory structure that mirrors the source code organization

## Policy Block

- MUST Test files MUST be organized in a dedicated tests/ directory structure that mirrors the source code organization

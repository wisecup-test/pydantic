...
1. SHOULD: Any newly introduced validator, serializer, or prebuilt definition requiring schema dictionary traversal SHOULD consume SchemaDict for configuration extraction.

## Policy Block

- SHOULD Any newly introduced validator, serializer, or prebuilt definition requiring schema dictionary traversal SHOULD consume SchemaDict for configuration extraction.

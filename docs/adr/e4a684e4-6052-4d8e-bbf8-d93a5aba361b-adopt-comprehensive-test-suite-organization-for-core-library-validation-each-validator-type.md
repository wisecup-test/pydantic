# Adopt Comprehensive Test Suite Organization for Core Library Validation: Each Validator Type
...
1. MUST: Each validator type MUST have a dedicated test file following the naming convention test_<validator_type>.py (e.g., test_float.py, test_complex.py, test_frozenset.py)

## Policy Block

- MUST Each validator type MUST have a dedicated test file following the naming convention test_<validator_type>.py (e.g., test_float.py, test_complex.py, test_frozenset.py)

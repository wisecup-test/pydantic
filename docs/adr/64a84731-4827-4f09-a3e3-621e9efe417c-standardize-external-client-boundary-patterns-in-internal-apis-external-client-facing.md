...
1. MUST: External client-facing interfaces MUST maintain backward compatibility within major versions and document any breaking changes

## Policy Block

- MUST External client-facing interfaces MUST maintain backward compatibility within major versions and document any breaking changes

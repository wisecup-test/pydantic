# Establish Public API Contracts for Design System Components: Internal Implementation Details
...
1. MUST_NOT: Internal implementation details MUST NOT be exposed as part of the public API contract and should be clearly marked as private

## Policy Block

- MUST_NOT Internal implementation details MUST NOT be exposed as part of the public API contract and should be clearly marked as private

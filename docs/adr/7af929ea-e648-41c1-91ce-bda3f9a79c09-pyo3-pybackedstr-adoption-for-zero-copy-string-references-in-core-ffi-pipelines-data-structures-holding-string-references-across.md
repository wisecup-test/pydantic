...
1. MUST_NOT: Data structures holding string references across serialization and validation boundaries MUST NOT convert incoming foreign strings into owned heap strings unless mutation or detachment from foreign runtime lifetimes is strictly necessary.

## Policy Block

- MUST_NOT Data structures holding string references across serialization and validation boundaries MUST NOT convert incoming foreign strings into owned heap strings unless mutation or detachment from foreign runtime lifetimes is strictly necessary.

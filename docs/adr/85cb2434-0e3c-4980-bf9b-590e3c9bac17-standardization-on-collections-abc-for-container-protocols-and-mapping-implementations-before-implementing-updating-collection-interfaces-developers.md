...
1. MUST: Before implementing or updating collection interfaces, developers MUST inspect the repository lock artifact to verify the active runtime environment specifications and library constraints.

## Policy Block

- MUST Before implementing or updating collection interfaces, developers MUST inspect the repository lock artifact to verify the active runtime environment specifications and library constraints.

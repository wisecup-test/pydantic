...
1. MUST: Modules defining structured internal state or introspecting data structures MUST adopt dataclasses module conventions to structure domain records and extract field definitions.

## Policy Block

- MUST Modules defining structured internal state or introspecting data structures MUST adopt dataclasses module conventions to structure domain records and extract field definitions.

...
1. MUST_NOT: Type serializers MUST NOT mutate runtime state outside the encapsulation guarantees provided by crate::serializers::SerializationState.

## Policy Block

- MUST_NOT Type serializers MUST NOT mutate runtime state outside the encapsulation guarantees provided by crate::serializers::SerializationState.

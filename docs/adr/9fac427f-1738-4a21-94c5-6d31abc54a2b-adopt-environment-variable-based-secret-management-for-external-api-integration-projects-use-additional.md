# Adopt Environment Variable-Based Secret Management for External API Integration: Projects Use Additional
...
1. MAY: Projects MAY use additional secret management tools (e.g., HashiCorp Vault, AWS Secrets Manager) that inject secrets as environment variables

## Policy Block

- MAY Projects MAY use additional secret management tools (e.g., HashiCorp Vault, AWS Secrets Manager) that inject secrets as environment variables

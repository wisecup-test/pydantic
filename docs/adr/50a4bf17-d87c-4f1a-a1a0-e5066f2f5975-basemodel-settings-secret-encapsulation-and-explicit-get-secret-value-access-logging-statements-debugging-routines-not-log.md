...
1. MUST_NOT: Logging statements and debugging routines MUST_NOT log the output of get_secret_value or bypass serialization masking.

## Policy Block

- MUST_NOT Logging statements and debugging routines MUST_NOT log the output of get_secret_value or bypass serialization masking.

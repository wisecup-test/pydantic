...
1. SHOULD: Diagnostic log records SHOULD include contextual iteration markers and response status codes to facilitate failure triage.

## Policy Block

- SHOULD Diagnostic log records SHOULD include contextual iteration markers and response status codes to facilitate failure triage.

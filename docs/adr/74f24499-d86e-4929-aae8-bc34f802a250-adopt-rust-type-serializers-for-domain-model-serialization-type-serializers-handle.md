...
1. MUST: Type serializers MUST handle domain-specific types including models, temporal types (timedelta), and sentinel values (missing_sentinel)

## Policy Block

- MUST Type serializers MUST handle domain-specific types including models, temporal types (timedelta), and sentinel values (missing_sentinel)

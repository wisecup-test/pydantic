...
1. MUST: Type serializers for set and frozenset MUST handle empty collections without errors

## Policy Block

- MUST Type serializers for set and frozenset MUST handle empty collections without errors

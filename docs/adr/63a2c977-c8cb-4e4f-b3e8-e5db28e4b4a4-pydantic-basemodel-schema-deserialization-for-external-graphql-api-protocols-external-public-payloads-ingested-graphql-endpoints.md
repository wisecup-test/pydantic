...
1. MUST: External public API payloads ingested from GraphQL endpoints MUST be parsed and validated through dedicated BaseModel schema classes before any field traversal occurs.

## Policy Block

- MUST External public API payloads ingested from GraphQL endpoints MUST be parsed and validated through dedicated BaseModel schema classes before any field traversal occurs.

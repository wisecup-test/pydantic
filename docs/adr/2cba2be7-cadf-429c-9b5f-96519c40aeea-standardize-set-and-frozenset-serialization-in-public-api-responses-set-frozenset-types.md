...
1. MUST: All set and frozenset types exposed through public API endpoints MUST be serialized to JSON arrays

## Policy Block

- MUST All set and frozenset types exposed through public API endpoints MUST be serialized to JSON arrays

...
1. MUST_NOT: External clients MUST NOT directly access internal implementation modules (those prefixed with underscore or marked as internal)

## Policy Block

- MUST_NOT External clients MUST NOT directly access internal implementation modules (those prefixed with underscore or marked as internal)

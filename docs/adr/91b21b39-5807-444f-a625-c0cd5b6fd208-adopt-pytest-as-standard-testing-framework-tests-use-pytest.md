...
1. SHOULD: Tests SHOULD use pytest fixtures for setup and teardown operations rather than class-based setUp/tearDown methods

## Policy Block

- SHOULD Tests SHOULD use pytest fixtures for setup and teardown operations rather than class-based setUp/tearDown methods

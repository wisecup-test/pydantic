...
1. MUST: Before introducing or updating usage of pyo3::sync::PyOnceLock, developers MUST inspect the repository dependency lock artifact to verify the exact resolved version of the foreign interface dependency against official documentation.

## Policy Block

- MUST Before introducing or updating usage of pyo3::sync::PyOnceLock, developers MUST inspect the repository dependency lock artifact to verify the exact resolved version of the foreign interface dependency against official documentation.

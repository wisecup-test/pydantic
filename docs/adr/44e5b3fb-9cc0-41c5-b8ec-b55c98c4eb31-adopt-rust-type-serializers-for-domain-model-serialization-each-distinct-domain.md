...
1. MUST: Each distinct domain type requiring specialized serialization logic MUST have its own type serializer module

## Policy Block

- MUST Each distinct domain type requiring specialized serialization logic MUST have its own type serializer module

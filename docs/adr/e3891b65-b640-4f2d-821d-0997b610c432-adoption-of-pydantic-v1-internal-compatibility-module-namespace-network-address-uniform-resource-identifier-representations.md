...
1. MUST: Network address and uniform resource identifier representations requiring schema validation MUST inherit from AnyUrl or implement the Parts and HostParts interface contracts within the pydantic.v1 namespace.

## Policy Block

- MUST Network address and uniform resource identifier representations requiring schema validation MUST inherit from AnyUrl or implement the Parts and HostParts interface contracts within the pydantic.v1 namespace.

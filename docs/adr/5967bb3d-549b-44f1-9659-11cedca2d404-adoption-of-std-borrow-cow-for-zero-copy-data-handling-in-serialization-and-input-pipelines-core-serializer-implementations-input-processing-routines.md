...
1. MUST: The core serializer implementations and input processing routines MUST use std::borrow::Cow when handling string or sequence transformations where data can remain borrowed without allocation.

## Policy Block

- MUST The core serializer implementations and input processing routines MUST use std::borrow::Cow when handling string or sequence transformations where data can remain borrowed without allocation.

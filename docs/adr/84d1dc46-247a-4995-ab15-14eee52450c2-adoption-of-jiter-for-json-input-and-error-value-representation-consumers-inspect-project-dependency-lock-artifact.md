...
1. MUST: Consumers MUST inspect the project dependency lock artifact to discover and resolve the exact locked version of jiter prior to integrating or modifying JSON evaluation paths.

## Policy Block

- MUST Consumers MUST inspect the project dependency lock artifact to discover and resolve the exact locked version of jiter prior to integrating or modifying JSON evaluation paths.

# Standardize Testing Fixtures for Public API Validation: Versioned Implementations Maintain
...
1. MUST: Versioned API implementations (e.g., v1, v2) MUST maintain separate fixture sets to validate version-specific behavior

## Policy Block

- MUST Versioned API implementations (e.g., v1, v2) MUST maintain separate fixture sets to validate version-specific behavior

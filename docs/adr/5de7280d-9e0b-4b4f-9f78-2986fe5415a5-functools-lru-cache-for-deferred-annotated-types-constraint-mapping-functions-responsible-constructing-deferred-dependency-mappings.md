...
1. MUST: Functions responsible for constructing deferred dependency mappings MUST apply functools.lru_cache to ensure that local import evaluation and dictionary allocation execute exactly once per process.

## Policy Block

- MUST Functions responsible for constructing deferred dependency mappings MUST apply functools.lru_cache to ensure that local import evaluation and dictionary allocation execute exactly once per process.

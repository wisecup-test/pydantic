...
1. SHOULD: Dynamic import dispatchers SHOULD register dynamic import mappings within an internal lookup table to avoid repeated resolution overhead on subsequent attribute accesses.

## Policy Block

- SHOULD Dynamic import dispatchers SHOULD register dynamic import mappings within an internal lookup table to avoid repeated resolution overhead on subsequent attribute accesses.

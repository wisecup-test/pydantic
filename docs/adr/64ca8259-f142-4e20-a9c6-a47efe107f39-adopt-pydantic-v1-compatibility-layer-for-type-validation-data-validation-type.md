# Adopt Pydantic V1 Compatibility Layer for Type Validation: Data Validation Type
...
1. MUST: All data validation and type checking MUST use Pydantic as the primary validation library

## Policy Block

- MUST All data validation and type checking MUST use Pydantic as the primary validation library

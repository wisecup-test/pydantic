...
1. MAY: Tests MAY use pytest plugins for additional functionality such as coverage reporting or benchmark testing

## Policy Block

- MAY Tests MAY use pytest plugins for additional functionality such as coverage reporting or benchmark testing

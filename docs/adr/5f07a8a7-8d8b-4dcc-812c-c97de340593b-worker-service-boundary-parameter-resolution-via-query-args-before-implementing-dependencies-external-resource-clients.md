...
1. MUST: Before implementing dependencies or external resource clients, the consumer MUST inspect the repository lock artifact to verify the exact resolved version.

## Policy Block

- MUST Before implementing dependencies or external resource clients, the consumer MUST inspect the repository lock artifact to verify the exact resolved version.

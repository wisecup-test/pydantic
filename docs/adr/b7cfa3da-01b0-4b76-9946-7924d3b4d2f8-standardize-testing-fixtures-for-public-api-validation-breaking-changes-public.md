# Standardize Testing Fixtures for Public API Validation: Breaking Changes Public
...
1. MUST: Breaking changes to public API behavior MUST be detected through fixture-based regression tests before release

## Policy Block

- MUST Breaking changes to public API behavior MUST be detected through fixture-based regression tests before release

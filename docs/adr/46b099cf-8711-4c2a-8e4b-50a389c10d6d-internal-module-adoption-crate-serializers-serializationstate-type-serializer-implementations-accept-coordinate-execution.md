...
1. MUST: Type serializer implementations MUST accept and coordinate execution context through crate::serializers::SerializationState rather than defining disparate parameter signatures for serialization state.

## Policy Block

- MUST Type serializer implementations MUST accept and coordinate execution context through crate::serializers::SerializationState rather than defining disparate parameter signatures for serialization state.

...
1. MUST: Unexpected network responses and execution errors at the worker boundary MUST be captured and reported via console.error logging.

## Policy Block

- MUST Unexpected network responses and execution errors at the worker boundary MUST be captured and reported via console.error logging.

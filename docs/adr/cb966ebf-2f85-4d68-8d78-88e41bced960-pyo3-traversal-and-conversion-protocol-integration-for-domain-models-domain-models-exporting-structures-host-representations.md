...
1. MUST: Domain models exporting structures into host representations MUST use IntoPyObjectExt to enforce explicit conversion semantics across domain boundaries.

## Policy Block

- MUST Domain models exporting structures into host representations MUST use IntoPyObjectExt to enforce explicit conversion semantics across domain boundaries.

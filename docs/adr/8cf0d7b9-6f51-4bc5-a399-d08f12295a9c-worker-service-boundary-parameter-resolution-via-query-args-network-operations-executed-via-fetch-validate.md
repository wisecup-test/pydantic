...
1. SHOULD: Network operations executed via fetch SHOULD validate response status and payload integrity before passing resolved data into runtime execution contexts.

## Policy Block

- SHOULD Network operations executed via fetch SHOULD validate response status and payload integrity before passing resolved data into runtime execution contexts.

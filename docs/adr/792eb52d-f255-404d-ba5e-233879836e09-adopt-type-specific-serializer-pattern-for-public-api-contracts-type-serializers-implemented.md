...
1. SHOULD: Type serializers SHOULD be implemented in separate files to maintain clear separation of concerns

## Policy Block

- SHOULD Type serializers SHOULD be implemented in separate files to maintain clear separation of concerns

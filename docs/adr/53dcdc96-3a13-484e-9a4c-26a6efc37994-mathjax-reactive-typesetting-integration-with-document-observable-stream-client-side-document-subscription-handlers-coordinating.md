...
1. SHOULD: Client-side document subscription handlers coordinating asynchronous typesetting SHOULD handle the promise returned by MathJax.typesetPromise to capture potential typesetting failures.

## Policy Block

- SHOULD Client-side document subscription handlers coordinating asynchronous typesetting SHOULD handle the promise returned by MathJax.typesetPromise to capture potential typesetting failures.

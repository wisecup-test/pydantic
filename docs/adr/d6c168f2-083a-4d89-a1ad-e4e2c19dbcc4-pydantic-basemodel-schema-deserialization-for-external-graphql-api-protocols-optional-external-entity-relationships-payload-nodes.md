...
1. MUST: Optional external entity relationships in payload nodes MUST be explicitly typed as nullable model references with default null assignments.

## Policy Block

- MUST Optional external entity relationships in payload nodes MUST be explicitly typed as nullable model references with default null assignments.

# Adopt Type Annotation and Runtime Validation for Public API Interfaces: Public Provide Custom
...
1. SHOULD: Public APIs SHOULD provide custom error messages with validation failures that clearly indicate the expected type and received value

## Policy Block

- SHOULD Public APIs SHOULD provide custom error messages with validation failures that clearly indicate the expected type and received value

...
1. MUST: Before consuming any external dependency associated with schema extraction bindings, developers MUST locate the project dependency lock artifact and verify the exact resolved version against public API documentation.

## Policy Block

- MUST Before consuming any external dependency associated with schema extraction bindings, developers MUST locate the project dependency lock artifact and verify the exact resolved version against public API documentation.

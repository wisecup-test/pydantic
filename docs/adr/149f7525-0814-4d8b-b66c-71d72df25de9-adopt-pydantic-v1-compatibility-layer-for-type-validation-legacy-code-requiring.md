# Adopt Pydantic V1 Compatibility Layer for Type Validation: Legacy Code Requiring
...
1. MUST: Legacy code requiring Pydantic V1 APIs MUST import from pydantic.v1 namespace, not from pydantic directly

## Policy Block

- MUST Legacy code requiring Pydantic V1 APIs MUST import from pydantic.v1 namespace, not from pydantic directly

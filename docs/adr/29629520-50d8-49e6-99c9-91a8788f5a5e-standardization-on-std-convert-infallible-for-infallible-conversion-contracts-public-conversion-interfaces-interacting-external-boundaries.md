...
1. MAY: Public conversion interfaces interacting with external boundaries MAY expose conversion helper traits that use std::convert::Infallible to bridge generic fallible signatures.

## Policy Block

- MAY Public conversion interfaces interacting with external boundaries MAY expose conversion helper traits that use std::convert::Infallible to bridge generic fallible signatures.

...
1. SHOULD: Repeated string keys accessed or constructed across dictionary serialization and validation routines SHOULD use pyo3::intern to avoid redundant Python string allocations.

## Policy Block

- SHOULD Repeated string keys accessed or constructed across dictionary serialization and validation routines SHOULD use pyo3::intern to avoid redundant Python string allocations.

...
1. MUST: Responses from external HTTP requests MUST undergo HTTP status code evaluation and error logging before extracting payload data.

## Policy Block

- MUST Responses from external HTTP requests MUST undergo HTTP status code evaluation and error logging before extracting payload data.

...
1. SHOULD: Static singletons and type references cached inside pyo3::sync::PyOnceLock SHOULD be encapsulated within dedicated accessor functions that manage lazy initialization transparently.

## Policy Block

- SHOULD Static singletons and type references cached inside pyo3::sync::PyOnceLock SHOULD be encapsulated within dedicated accessor functions that manage lazy initialization transparently.

# Enforce Domain Validation in Public API Models: Endpoints Not Accept
...
1. MUST_NOT: API endpoints MUST NOT accept unvalidated dictionaries or generic types as input parameters for public APIs

## Policy Block

- MUST_NOT API endpoints MUST NOT accept unvalidated dictionaries or generic types as input parameters for public APIs

# Establish Pydantic as Standard Data Validation and Configuration Framework: Teams Extend Pydantic
...
1. MAY: Teams MAY extend Pydantic with custom validators for domain-specific validation requirements

## Policy Block

- MAY Teams MAY extend Pydantic with custom validators for domain-specific validation requirements

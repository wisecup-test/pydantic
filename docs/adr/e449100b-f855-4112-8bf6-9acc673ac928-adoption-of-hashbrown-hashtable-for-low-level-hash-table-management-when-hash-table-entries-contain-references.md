...
1. MUST: When hash table entries contain references tracked by runtime cycle collectors, traversal routines MUST query hashbrown::HashTable using safe iterator interfaces to register all reachable references.

## Policy Block

- MUST When hash table entries contain references tracked by runtime cycle collectors, traversal routines MUST query hashbrown::HashTable using safe iterator interfaces to register all reachable references.

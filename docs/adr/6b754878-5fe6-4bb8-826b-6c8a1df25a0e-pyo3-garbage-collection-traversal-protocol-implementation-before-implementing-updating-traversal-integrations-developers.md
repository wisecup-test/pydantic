...
1. MUST: Before implementing or updating traversal integrations, developers MUST inspect the repository dependency manifest and authoritative lock artifact to resolve the exact locked version of the pyo3 library and its documentation.

## Policy Block

- MUST Before implementing or updating traversal integrations, developers MUST inspect the repository dependency manifest and authoritative lock artifact to resolve the exact locked version of the pyo3 library and its documentation.

...
1. MUST: Developers MUST inspect the authoritative lock artifact in the repository to resolve the exact dependency version before integrating with the validation engine.

## Policy Block

- MUST Developers MUST inspect the authoritative lock artifact in the repository to resolve the exact dependency version before integrating with the validation engine.

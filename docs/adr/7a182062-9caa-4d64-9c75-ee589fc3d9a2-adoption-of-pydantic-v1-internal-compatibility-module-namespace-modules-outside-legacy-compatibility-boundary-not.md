...
1. MUST_NOT: Modules outside the legacy compatibility boundary MUST NOT import deprecated validation constructs directly when contemporary replacement contracts are available in root module namespaces.

## Policy Block

- MUST_NOT Modules outside the legacy compatibility boundary MUST NOT import deprecated validation constructs directly when contemporary replacement contracts are available in root module namespaces.

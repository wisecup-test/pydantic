...
1. MUST: Special sentinel values (e.g., missing, undefined) MUST have dedicated serializer implementations to ensure API contract clarity

## Policy Block

- MUST Special sentinel values (e.g., missing, undefined) MUST have dedicated serializer implementations to ensure API contract clarity

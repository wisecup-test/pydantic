# Adopt Environment Variable-Based Secret Management for External API Integration: Documentation Clearly Specify
...
1. SHOULD: Documentation SHOULD clearly specify which environment variables are required for each external API integration

## Policy Block

- SHOULD Documentation SHOULD clearly specify which environment variables are required for each external API integration

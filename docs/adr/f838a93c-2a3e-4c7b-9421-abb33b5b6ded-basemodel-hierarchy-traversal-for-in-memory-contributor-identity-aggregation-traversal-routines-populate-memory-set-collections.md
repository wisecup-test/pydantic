...
1. SHOULD: Traversal routines SHOULD populate in-memory set collections directly during node iteration to guarantee unique identity extraction.

## Policy Block

- SHOULD Traversal routines SHOULD populate in-memory set collections directly during node iteration to guarantee unique identity extraction.

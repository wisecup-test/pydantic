...
1. MUST: Schema gathering and union constraint pushdown routines MUST explicitly account for the MISSING sentinel when evaluating discriminated types and union branches.

## Policy Block

- MUST Schema gathering and union constraint pushdown routines MUST explicitly account for the MISSING sentinel when evaluating discriminated types and union branches.

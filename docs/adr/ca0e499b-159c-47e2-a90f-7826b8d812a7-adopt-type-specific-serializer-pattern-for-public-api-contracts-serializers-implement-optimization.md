...
1. MAY: Serializers MAY implement optimization strategies specific to their type category

## Policy Block

- MAY Serializers MAY implement optimization strategies specific to their type category

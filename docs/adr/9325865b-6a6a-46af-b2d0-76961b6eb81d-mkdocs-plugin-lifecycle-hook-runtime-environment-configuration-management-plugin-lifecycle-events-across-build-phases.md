...
1. SHOULD: Plugin lifecycle events across build phases SHOULD log operational warnings and state transitions through plugin logging instances obtained from logging getLogger.

## Policy Block

- SHOULD Plugin lifecycle events across build phases SHOULD log operational warnings and state transitions through plugin logging instances obtained from logging getLogger.

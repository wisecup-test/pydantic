...
1. MUST: All modules that handle core metadata, configuration, or cross-module interactions MUST include integration tests that validate behavior across component boundaries

## Policy Block

- MUST All modules that handle core metadata, configuration, or cross-module interactions MUST include integration tests that validate behavior across component boundaries

# Adopt Runtime Configuration Sources for Plugin and Extension Systems: Configuration Precedence Follow
...
1. SHOULD: Configuration precedence SHOULD follow a clear hierarchy (e.g., environment variables > config files > defaults) that is documented and consistent

## Policy Block

- SHOULD Configuration precedence SHOULD follow a clear hierarchy (e.g., environment variables > config files > defaults) that is documented and consistent

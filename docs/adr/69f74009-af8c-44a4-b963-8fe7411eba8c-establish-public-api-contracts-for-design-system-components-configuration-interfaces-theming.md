# Establish Public API Contracts for Design System Components: Configuration Interfaces Theming
...
1. SHOULD: Configuration interfaces for theming and customization SHOULD be defined through explicit contract schemas that validate consumer inputs

## Policy Block

- SHOULD Configuration interfaces for theming and customization SHOULD be defined through explicit contract schemas that validate consumer inputs

...
1. MUST: Core class construction metaclasses MUST wrap captured parent namespaces in weak reference dictionaries derived from the standard library weakref module rather than storing raw dictionary or frame references.

## Policy Block

- MUST Core class construction metaclasses MUST wrap captured parent namespaces in weak reference dictionaries derived from the standard library weakref module rather than storing raw dictionary or frame references.

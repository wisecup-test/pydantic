...
1. MAY: Enumerations with purely internal machine-oriented discriminant semantics and no client-facing message requirements MAY omit strum::EnumMessage derivations.

## Policy Block

- MAY Enumerations with purely internal machine-oriented discriminant semantics and no client-facing message requirements MAY omit strum::EnumMessage derivations.

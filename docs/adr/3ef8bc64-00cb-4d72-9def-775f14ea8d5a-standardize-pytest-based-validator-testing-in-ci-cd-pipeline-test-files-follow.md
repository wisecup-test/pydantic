# Standardize Pytest-Based Validator Testing in CI/CD Pipeline: Test Files Follow
...
1. SHOULD: Test files SHOULD follow the naming convention test_<validator_name>.py for consistency and discoverability

## Policy Block

- SHOULD Test files SHOULD follow the naming convention test_<validator_name>.py for consistency and discoverability

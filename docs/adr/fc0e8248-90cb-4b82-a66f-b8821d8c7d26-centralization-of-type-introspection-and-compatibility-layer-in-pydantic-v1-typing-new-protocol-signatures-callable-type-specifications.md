...
1. SHOULD: New protocol signatures and callable type specifications exposed across module boundaries SHOULD be registered in the shared typing module to prevent type drift.

## Policy Block

- SHOULD New protocol signatures and callable type specifications exposed across module boundaries SHOULD be registered in the shared typing module to prevent type drift.

# Enforce Domain Validation in Public API Models: Models Implement Custom
...
1. MAY: API models MAY implement custom validators for complex business rules that cannot be expressed through type annotations alone

## Policy Block

- MAY API models MAY implement custom validators for complex business rules that cannot be expressed through type annotations alone

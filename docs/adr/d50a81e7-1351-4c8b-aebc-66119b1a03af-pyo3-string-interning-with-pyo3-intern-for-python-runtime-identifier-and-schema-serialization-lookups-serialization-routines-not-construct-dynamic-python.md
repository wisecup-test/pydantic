...
1. MUST_NOT: Serialization routines MUST NOT construct dynamic Python string instances for constant field names or known schema keys.

## Policy Block

- MUST_NOT Serialization routines MUST NOT construct dynamic Python string instances for constant field names or known schema keys.

# Adopt Comprehensive Test Suite Organization for Core Library Validation: Test Files Organized
...
1. MUST: Test files MUST be organized hierarchically by functional domain (validators, serializers, arguments) with dedicated subdirectories for each category

## Policy Block

- MUST Test files MUST be organized hierarchically by functional domain (validators, serializers, arguments) with dedicated subdirectories for each category

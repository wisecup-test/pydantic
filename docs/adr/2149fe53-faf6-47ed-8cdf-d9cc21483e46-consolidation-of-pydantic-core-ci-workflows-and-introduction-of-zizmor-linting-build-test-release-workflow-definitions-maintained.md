...
1. MUST: All build, test, and release workflow definitions MUST be maintained in the root .github/workflows directory.

## Policy Block

- MUST All build, test, and release workflow definitions MUST be maintained in the root .github/workflows directory.

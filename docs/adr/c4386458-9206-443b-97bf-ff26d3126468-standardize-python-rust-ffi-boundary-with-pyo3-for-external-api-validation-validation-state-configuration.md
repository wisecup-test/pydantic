# Standardize Python-Rust FFI Boundary with PyO3 for External API Validation: Validation State Configuration
...
1. MUST: Validation state and configuration objects crossing the FFI boundary MUST implement proper Python garbage collection integration via py_gc module

## Policy Block

- MUST Validation state and configuration objects crossing the FFI boundary MUST implement proper Python garbage collection integration via py_gc module

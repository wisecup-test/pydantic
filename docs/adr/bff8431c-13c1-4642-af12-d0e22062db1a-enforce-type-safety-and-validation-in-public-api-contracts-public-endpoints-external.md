# Enforce Type Safety and Validation in Public API Contracts: Public Endpoints External
...
1. MUST: All public API endpoints and external integration points MUST use Pydantic models or equivalent type validation frameworks to validate input data at runtime

## Policy Block

- MUST All public API endpoints and external integration points MUST use Pydantic models or equivalent type validation frameworks to validate input data at runtime

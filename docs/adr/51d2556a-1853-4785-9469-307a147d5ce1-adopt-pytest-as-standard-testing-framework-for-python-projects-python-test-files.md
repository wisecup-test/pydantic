# Adopt pytest as Standard Testing Framework for Python Projects: Python Test Files
...
1. MUST: All Python test files MUST use pytest as the testing framework and follow pytest naming conventions (test_*.py or *_test.py)

## Policy Block

- MUST All Python test files MUST use pytest as the testing framework and follow pytest naming conventions (test_*.py or *_test.py)

...
1. MUST: Developers MUST inspect the project lock artifact to resolve and verify the exact dependency configuration before introducing or updating input processing and lookup path dependencies.

## Policy Block

- MUST Developers MUST inspect the project lock artifact to resolve and verify the exact dependency configuration before introducing or updating input processing and lookup path dependencies.

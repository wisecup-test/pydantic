...
1. MUST: Engineers MUST discover the project dependency manifest and lock artifact to verify the exact resolved version of the data validation library before implementing model definitions.

## Policy Block

- MUST Engineers MUST discover the project dependency manifest and lock artifact to verify the exact resolved version of the data validation library before implementing model definitions.

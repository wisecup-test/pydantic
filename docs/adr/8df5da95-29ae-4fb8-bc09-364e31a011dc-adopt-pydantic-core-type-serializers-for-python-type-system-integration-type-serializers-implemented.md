...
1. SHOULD: Type serializers SHOULD be implemented in Rust for performance-critical paths while maintaining Python API compatibility

## Policy Block

- SHOULD Type serializers SHOULD be implemented in Rust for performance-critical paths while maintaining Python API compatibility

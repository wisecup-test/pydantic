...
1. SHOULD: Downstream call sites consuming results typed with std::convert::Infallible SHOULD eliminate impossible error variants statically through exhaustive pattern matching rather than invoking runtime unwrap routines.

## Policy Block

- SHOULD Downstream call sites consuming results typed with std::convert::Infallible SHOULD eliminate impossible error variants statically through exhaustive pattern matching rather than invoking runtime unwrap routines.

...
1. MUST: The consumer MUST inspect the project dependency lock artifact to resolve the exact locked versions of all external derivation dependencies before implementing trait derivations.

## Policy Block

- MUST The consumer MUST inspect the project dependency lock artifact to resolve the exact locked versions of all external derivation dependencies before implementing trait derivations.

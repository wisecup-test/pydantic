...
1. MAY: Type serializers MAY query crate::serializers::SerializationState to conditionally adjust serialization output formats based on configured runtime options.

## Policy Block

- MAY Type serializers MAY query crate::serializers::SerializationState to conditionally adjust serialization output formats based on configured runtime options.

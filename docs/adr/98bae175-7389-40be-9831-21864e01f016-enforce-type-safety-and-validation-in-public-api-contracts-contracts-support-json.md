# Enforce Type Safety and Validation in Public API Contracts: Contracts Support Json
...
1. SHOULD: API contracts SHOULD support JSON serialization and deserialization with proper handling of complex types (datetime, timezone, enums)

## Policy Block

- SHOULD API contracts SHOULD support JSON serialization and deserialization with proper handling of complex types (datetime, timezone, enums)

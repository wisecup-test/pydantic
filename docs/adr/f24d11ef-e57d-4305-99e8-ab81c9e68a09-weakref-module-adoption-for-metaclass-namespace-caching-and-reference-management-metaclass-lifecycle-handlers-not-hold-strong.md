...
1. MUST_NOT: Metaclass lifecycle handlers MUST_NOT hold strong references to execution frames, caller globals, or mutable namespace dictionaries across class construction boundaries.

## Policy Block

- MUST_NOT Metaclass lifecycle handlers MUST_NOT hold strong references to execution frames, caller globals, or mutable namespace dictionaries across class construction boundaries.

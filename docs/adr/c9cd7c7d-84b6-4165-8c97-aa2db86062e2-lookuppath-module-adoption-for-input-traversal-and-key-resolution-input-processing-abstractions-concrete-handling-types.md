...
1. MUST: Input processing abstractions and concrete input handling types MUST use LookupPath for defining and executing path-based key navigation and element resolution.

## Policy Block

- MUST Input processing abstractions and concrete input handling types MUST use LookupPath for defining and executing path-based key navigation and element resolution.

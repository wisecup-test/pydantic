# Establish Public API Contracts for Design System Components: Public Contracts Versioned
...
1. MUST: Public API contracts MUST be versioned and follow semantic versioning principles where breaking changes increment major versions

## Policy Block

- MUST Public API contracts MUST be versioned and follow semantic versioning principles where breaking changes increment major versions

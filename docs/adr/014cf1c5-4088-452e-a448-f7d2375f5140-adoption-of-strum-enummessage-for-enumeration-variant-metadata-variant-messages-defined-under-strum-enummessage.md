...
1. SHOULD: Variant messages defined under strum::EnumMessage SHOULD provide concise, human-readable descriptions that remain consistent across validation and serialization boundaries.

## Policy Block

- SHOULD Variant messages defined under strum::EnumMessage SHOULD provide concise, human-readable descriptions that remain consistent across validation and serialization boundaries.

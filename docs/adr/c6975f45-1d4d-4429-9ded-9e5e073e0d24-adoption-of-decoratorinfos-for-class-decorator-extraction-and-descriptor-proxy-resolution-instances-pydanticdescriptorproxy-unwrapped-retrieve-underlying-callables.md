...
1. SHOULD: Instances of PydanticDescriptorProxy MUST be unwrapped to retrieve underlying callables while preserving descriptor protocols across attribute lookups.

## Policy Block

- SHOULD Instances of PydanticDescriptorProxy MUST be unwrapped to retrieve underlying callables while preserving descriptor protocols across attribute lookups.

...
1. MUST: Serializer construction routines MUST utilize crate::definitions::DefinitionsBuilder to register and resolve recursive definition references across serialization boundaries.

## Policy Block

- MUST Serializer construction routines MUST utilize crate::definitions::DefinitionsBuilder to register and resolve recursive definition references across serialization boundaries.

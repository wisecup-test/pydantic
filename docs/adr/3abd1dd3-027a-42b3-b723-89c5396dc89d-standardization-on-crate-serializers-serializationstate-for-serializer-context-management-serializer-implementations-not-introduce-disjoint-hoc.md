...
1. MUST_NOT: Serializer implementations MUST NOT introduce disjoint, ad-hoc state objects or thread-local storage for state data that belongs to the active serialization pass.

## Policy Block

- MUST_NOT Serializer implementations MUST NOT introduce disjoint, ad-hoc state objects or thread-local storage for state data that belongs to the active serialization pass.

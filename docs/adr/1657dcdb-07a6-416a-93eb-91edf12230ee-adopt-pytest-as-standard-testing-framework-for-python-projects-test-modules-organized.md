# Adopt pytest as Standard Testing Framework for Python Projects: Test Modules Organized
...
1. SHOULD: Test modules SHOULD be organized by functional area (e.g., validators/, serializers/) to improve test discoverability

## Policy Block

- SHOULD Test modules SHOULD be organized by functional area (e.g., validators/, serializers/) to improve test discoverability

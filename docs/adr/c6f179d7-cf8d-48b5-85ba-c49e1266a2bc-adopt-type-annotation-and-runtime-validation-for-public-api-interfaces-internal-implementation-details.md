# Adopt Type Annotation and Runtime Validation for Public API Interfaces: Internal Implementation Details
...
1. MAY: Internal implementation details MAY use less strict type annotations if they are not exposed through public interfaces

## Policy Block

- MAY Internal implementation details MAY use less strict type annotations if they are not exposed through public interfaces

...
1. MUST: Native modules requiring static or lazily resolved foreign runtime types, singleton sentinels, or shared lookup tables MUST utilize pyo3::sync::PyOnceLock to ensure thread-safe one-time initialization.

## Policy Block

- MUST Native modules requiring static or lazily resolved foreign runtime types, singleton sentinels, or shared lookup tables MUST utilize pyo3::sync::PyOnceLock to ensure thread-safe one-time initialization.

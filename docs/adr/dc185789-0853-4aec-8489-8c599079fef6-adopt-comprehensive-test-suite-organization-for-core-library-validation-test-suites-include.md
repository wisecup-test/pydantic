...
1. MUST: Test suites MUST include coverage for both strict and lax validation modes where applicable

## Policy Block

- MUST Test suites MUST include coverage for both strict and lax validation modes where applicable

# Adopt Runtime Configuration Sources for Plugin and Extension Systems: Configuration Source Loaders
...
1. MUST: Configuration source loaders MUST implement error handling for missing or malformed configuration data with clear error messages

## Policy Block

- MUST Configuration source loaders MUST implement error handling for missing or malformed configuration data with clear error messages

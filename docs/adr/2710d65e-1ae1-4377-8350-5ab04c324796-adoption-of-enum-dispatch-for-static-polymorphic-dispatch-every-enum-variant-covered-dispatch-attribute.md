...
1. MUST: Every enum variant covered by an enum_dispatch attribute MUST implement the annotated dispatch trait directly.

## Policy Block

- MUST Every enum variant covered by an enum_dispatch attribute MUST implement the annotated dispatch trait directly.

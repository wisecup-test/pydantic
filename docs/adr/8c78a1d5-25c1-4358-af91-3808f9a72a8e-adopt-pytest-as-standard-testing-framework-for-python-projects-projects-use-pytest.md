# Adopt pytest as Standard Testing Framework for Python Projects: Projects Use Pytest
...
1. MAY: Projects MAY use pytest plugins (e.g., pytest-cov, pytest-xdist) to extend testing capabilities

## Policy Block

- MAY Projects MAY use pytest plugins (e.g., pytest-cov, pytest-xdist) to extend testing capabilities

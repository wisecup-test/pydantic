...
1. MUST_NOT: Internal modules MUST NOT bypass pydantic_core schema structures to perform raw validation or custom serialization on core model definitions.

## Policy Block

- MUST_NOT Internal modules MUST NOT bypass pydantic_core schema structures to perform raw validation or custom serialization on core model definitions.

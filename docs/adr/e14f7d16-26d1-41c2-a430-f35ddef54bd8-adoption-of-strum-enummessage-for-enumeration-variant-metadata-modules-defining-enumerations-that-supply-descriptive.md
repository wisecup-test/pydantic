...
1. MUST: Modules defining enumerations that supply descriptive messages or error labels for input handling and validation MUST implement strum::EnumMessage via derive declarations.

## Policy Block

- MUST Modules defining enumerations that supply descriptive messages or error labels for input handling and validation MUST implement strum::EnumMessage via derive declarations.

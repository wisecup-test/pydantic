...
1. MUST: Authentication tokens and client secrets passed to external API endpoints MUST be retrieved using secret masking accessors rather than raw environment string exposure.

## Policy Block

- MUST Authentication tokens and client secrets passed to external API endpoints MUST be retrieved using secret masking accessors rather than raw environment string exposure.

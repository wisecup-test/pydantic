...
1. MUST: Internal schema generation and data validation layers MUST delegate core validation and serialization execution to pydantic_core schema structures.

## Policy Block

- MUST Internal schema generation and data validation layers MUST delegate core validation and serialization execution to pydantic_core schema structures.

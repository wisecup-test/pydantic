...
1. MAY: Native serializers handling dynamic string references MAY utilize std::borrow::Cow to avoid unnecessary memory allocations when interacting with interned Python strings via pyo3::intern.

## Policy Block

- MAY Native serializers handling dynamic string references MAY utilize std::borrow::Cow to avoid unnecessary memory allocations when interacting with interned Python strings via pyo3::intern.

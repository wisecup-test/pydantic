...
1. SHOULD: Return data structures exposing native representations to the foreign runtime SHOULD implement or derive IntoPyObject to guarantee uniform serialization across boundary contracts.

## Policy Block

- SHOULD Return data structures exposing native representations to the foreign runtime SHOULD implement or derive IntoPyObject to guarantee uniform serialization across boundary contracts.

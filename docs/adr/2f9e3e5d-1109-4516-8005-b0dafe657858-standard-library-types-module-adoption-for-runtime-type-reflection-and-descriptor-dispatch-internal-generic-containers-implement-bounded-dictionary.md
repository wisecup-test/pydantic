...
1. MAY: Internal generic containers MAY implement bounded dictionary caches to prevent unbounded memory growth during repeated generic submodel creation.

## Policy Block

- MAY Internal generic containers MAY implement bounded dictionary caches to prevent unbounded memory growth during repeated generic submodel creation.

...
1. MUST: Components requiring secret credentials MUST access the underlying plain-text value strictly through explicit get_secret_value calls at the external communication boundary.

## Policy Block

- MUST Components requiring secret credentials MUST access the underlying plain-text value strictly through explicit get_secret_value calls at the external communication boundary.

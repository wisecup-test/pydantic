...
1. MUST: Runtime harness logic MUST configure recursion limits via sys.setrecursionlimit prior to executing heavy test harnesses in sandboxed interpreters.

## Policy Block

- MUST Runtime harness logic MUST configure recursion limits via sys.setrecursionlimit prior to executing heavy test harnesses in sandboxed interpreters.

...
1. MUST: The native core architecture MUST use pyo3 as the primary library for foreign runtime interoperability, object conversion, and boundary exception management across all native validation and input processing interfaces.

## Policy Block

- MUST The native core architecture MUST use pyo3 as the primary library for foreign runtime interoperability, object conversion, and boundary exception management across all native validation and input processing interfaces.

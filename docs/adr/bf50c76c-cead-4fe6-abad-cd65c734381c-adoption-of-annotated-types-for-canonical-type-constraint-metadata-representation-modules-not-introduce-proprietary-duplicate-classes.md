...
1. MUST_NOT: Modules MUST NOT introduce proprietary duplicate classes for standard constraint definitions already provided by `annotated_types`.

## Policy Block

- MUST_NOT Modules MUST NOT introduce proprietary duplicate classes for standard constraint definitions already provided by `annotated_types`.

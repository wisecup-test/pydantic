...
1. MUST_NOT: Native boundary routines MUST_NOT construct arbitrary unchecked native error variants when host callers expect standard type failure contracts represented by pyo3::exceptions::PyTypeError.

## Policy Block

- MUST_NOT Native boundary routines MUST_NOT construct arbitrary unchecked native error variants when host callers expect standard type failure contracts represented by pyo3::exceptions::PyTypeError.

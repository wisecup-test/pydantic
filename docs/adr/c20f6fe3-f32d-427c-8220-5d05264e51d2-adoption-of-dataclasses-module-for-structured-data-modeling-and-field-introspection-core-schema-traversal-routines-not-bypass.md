...
1. MUST_NOT: Core schema traversal routines MUST_NOT bypass definition reference mapping when collecting schema metadata from dataclass models.

## Policy Block

- MUST_NOT Core schema traversal routines MUST_NOT bypass definition reference mapping when collecting schema metadata from dataclass models.

...
1. SHOULD: String literal lookups and static dictionary key conversions across the foreign function interface boundary SHOULD coordinate with pyo3::intern or PyBackedStr to avoid duplicate object allocations.

## Policy Block

- SHOULD String literal lookups and static dictionary key conversions across the foreign function interface boundary SHOULD coordinate with pyo3::intern or PyBackedStr to avoid duplicate object allocations.

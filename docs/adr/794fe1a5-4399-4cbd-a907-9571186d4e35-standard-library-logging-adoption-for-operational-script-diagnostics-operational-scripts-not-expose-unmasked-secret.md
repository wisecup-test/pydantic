...
1. MUST_NOT: Operational scripts MUST_NOT expose unmasked secret tokens or private credentials when emitting diagnostic log records.

## Policy Block

- MUST_NOT Operational scripts MUST_NOT expose unmasked secret tokens or private credentials when emitting diagnostic log records.

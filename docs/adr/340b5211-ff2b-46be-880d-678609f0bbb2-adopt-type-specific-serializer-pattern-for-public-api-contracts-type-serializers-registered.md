...
1. MUST: Type serializers MUST be registered through a central module (mod.rs) that coordinates serializer selection

## Policy Block

- MUST Type serializers MUST be registered through a central module (mod.rs) that coordinates serializer selection

# Enforce Type Safety and Validation in Public API Contracts: Internal Between Trusted
...
1. MAY: Internal APIs between trusted services MAY use relaxed validation if performance requirements justify it and risks are documented

## Policy Block

- MAY Internal APIs between trusted services MAY use relaxed validation if performance requirements justify it and risks are documented

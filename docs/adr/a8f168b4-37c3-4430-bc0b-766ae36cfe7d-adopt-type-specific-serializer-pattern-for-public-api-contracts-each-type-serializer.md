...
1. MUST: Each type serializer MUST handle its own type category independently (e.g., timedelta, model, missing_sentinel, other)

## Policy Block

- MUST Each type serializer MUST handle its own type category independently (e.g., timedelta, model, missing_sentinel, other)

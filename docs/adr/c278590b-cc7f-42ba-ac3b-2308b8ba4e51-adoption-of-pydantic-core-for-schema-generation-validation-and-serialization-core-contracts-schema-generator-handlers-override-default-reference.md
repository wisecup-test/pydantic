...
1. MAY: Schema generator handlers MAY override default reference unwrapping behavior when processing annotated metadata to prevent conflicting modifications to definition schemas.

## Policy Block

- MAY Schema generator handlers MAY override default reference unwrapping behavior when processing annotated metadata to prevent conflicting modifications to definition schemas.

...
1. SHOULD: Type signatures across internal module boundaries representing container protocols SHOULD reference abstract base classes from collections.abc instead of concrete container types.

## Policy Block

- SHOULD Type signatures across internal module boundaries representing container protocols SHOULD reference abstract base classes from collections.abc instead of concrete container types.

# Standardize Python-Rust FFI Boundary with PyO3 for External API Validation: Computed Fields Dynamic
...
1. MAY: Computed fields and dynamic serialization MAY use runtime type inspection when compile-time types are insufficient

## Policy Block

- MAY Computed fields and dynamic serialization MAY use runtime type inspection when compile-time types are insufficient

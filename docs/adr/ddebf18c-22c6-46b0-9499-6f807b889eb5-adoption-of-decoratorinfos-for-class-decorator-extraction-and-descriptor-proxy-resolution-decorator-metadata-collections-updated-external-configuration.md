...
1. MAY: Decorator metadata collections MAY be updated with external configuration wrappers after initial construction to incorporate inheritance overrides.

## Policy Block

- MAY Decorator metadata collections MAY be updated with external configuration wrappers after initial construction to incorporate inheritance overrides.

...
1. SHOULD: Integration tests SHOULD be organized separately from unit tests to enable independent execution and clear distinction of test scope

## Policy Block

- SHOULD Integration tests SHOULD be organized separately from unit tests to enable independent execution and clear distinction of test scope

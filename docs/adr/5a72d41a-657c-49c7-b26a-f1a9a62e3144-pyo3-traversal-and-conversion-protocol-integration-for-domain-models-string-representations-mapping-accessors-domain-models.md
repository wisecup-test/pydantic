...
1. SHOULD: String representations and mapping accessors in domain models SHOULD utilize PyBackedStr and intern to minimize allocation overhead during repeated key lookups.

## Policy Block

- SHOULD String representations and mapping accessors in domain models SHOULD utilize PyBackedStr and intern to minimize allocation overhead during repeated key lookups.

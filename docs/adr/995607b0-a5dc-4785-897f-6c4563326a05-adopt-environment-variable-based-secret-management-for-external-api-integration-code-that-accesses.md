# Adopt Environment Variable-Based Secret Management for External API Integration: Code That Accesses
...
1. MUST: Code that accesses external APIs MUST handle missing or invalid credentials gracefully with clear error messages

## Policy Block

- MUST Code that accesses external APIs MUST handle missing or invalid credentials gracefully with clear error messages

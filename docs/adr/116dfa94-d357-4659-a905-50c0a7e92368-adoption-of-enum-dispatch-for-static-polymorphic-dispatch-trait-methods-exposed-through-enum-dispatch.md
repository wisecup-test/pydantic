...
1. SHOULD: Trait methods exposed through enum_dispatch SHOULD avoid manual match boilerplate in consuming modules and rely on the generated static dispatch expansions.

## Policy Block

- SHOULD Trait methods exposed through enum_dispatch SHOULD avoid manual match boilerplate in consuming modules and rely on the generated static dispatch expansions.

...
1. MUST: Polymorphic trait dispatch across enum variants representing validators or garbage collection traversable components MUST use the enum_dispatch attribute macro on both trait definitions and wrapping enums.

## Policy Block

- MUST Polymorphic trait dispatch across enum variants representing validators or garbage collection traversable components MUST use the enum_dispatch attribute macro on both trait definitions and wrapping enums.

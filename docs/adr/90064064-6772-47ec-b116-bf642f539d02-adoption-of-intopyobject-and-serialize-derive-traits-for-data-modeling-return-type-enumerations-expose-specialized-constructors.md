...
1. MAY: Return type enumerations MAY expose specialized constructors to differentiate strict and lax boundary validation modes.

## Policy Block

- MAY Return type enumerations MAY expose specialized constructors to differentiate strict and lax boundary validation modes.

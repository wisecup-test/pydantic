# Adopt Environment Variable-Based Secret Management for External API Integration: Environment Variable Names
...
1. MUST: Environment variable names for API credentials MUST follow a consistent naming convention (e.g., SERVICE_NAME_API_KEY, SERVICE_NAME_TOKEN)

## Policy Block

- MUST Environment variable names for API credentials MUST follow a consistent naming convention (e.g., SERVICE_NAME_API_KEY, SERVICE_NAME_TOKEN)

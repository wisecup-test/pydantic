# Adopt Pydantic V1 Compatibility Layer for Type Validation: Type Validation Logic
...
1. MUST: Type validation logic MUST be tested with dedicated type checking test files following the pattern in tests/typechecking/

## Policy Block

- MUST Type validation logic MUST be tested with dedicated type checking test files following the pattern in tests/typechecking/

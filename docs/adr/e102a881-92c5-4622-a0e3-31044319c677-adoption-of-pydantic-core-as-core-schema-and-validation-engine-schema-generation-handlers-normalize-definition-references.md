...
1. SHOULD: Schema generation handlers SHOULD normalize definition references through centralized handler callbacks before submitting them to the core engine.

## Policy Block

- SHOULD Schema generation handlers SHOULD normalize definition references through centralized handler callbacks before submitting them to the core engine.

...
1. MUST: The consumer MUST discover the project dependency specification and resolve the authoritative locked environment before applying changes to field reflection or signature synthesis routines.

## Policy Block

- MUST The consumer MUST discover the project dependency specification and resolve the authoritative locked environment before applying changes to field reflection or signature synthesis routines.

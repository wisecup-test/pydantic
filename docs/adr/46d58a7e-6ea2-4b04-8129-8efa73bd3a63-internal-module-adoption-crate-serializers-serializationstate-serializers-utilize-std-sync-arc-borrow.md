...
1. MAY: Serializers MAY utilize std::sync::Arc or std::borrow::Cow pointer primitives when storing reusable state within serializer structures.

## Policy Block

- MAY Serializers MAY utilize std::sync::Arc or std::borrow::Cow pointer primitives when storing reusable state within serializer structures.

...
1. MUST: Domain components maintaining references to host runtime objects MUST implement visitor traversal using PyGcTraverse with PyVisit and PyTraverseError to participate in cycle detection.

## Policy Block

- MUST Domain components maintaining references to host runtime objects MUST implement visitor traversal using PyGcTraverse with PyVisit and PyTraverseError to participate in cycle detection.

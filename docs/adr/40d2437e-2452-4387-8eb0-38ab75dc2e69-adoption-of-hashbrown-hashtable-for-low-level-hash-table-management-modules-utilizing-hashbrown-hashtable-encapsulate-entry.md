...
1. SHOULD: Modules utilizing hashbrown::HashTable SHOULD encapsulate entry hashing, resizing, and bucket querying within dedicated wrapper interfaces to prevent raw table operations from leaking across module boundaries.

## Policy Block

- SHOULD Modules utilizing hashbrown::HashTable SHOULD encapsulate entry hashing, resizing, and bucket querying within dedicated wrapper interfaces to prevent raw table operations from leaking across module boundaries.

...
1. MUST: Type constraint declarations and field boundary validations MUST use `annotated_types` metadata classes as their canonical representation within type annotations and pipeline chains.

## Policy Block

- MUST Type constraint declarations and field boundary validations MUST use `annotated_types` metadata classes as their canonical representation within type annotations and pipeline chains.

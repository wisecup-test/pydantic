...
1. MUST: Internal runtime modules requiring direct bucket manipulation or specialized memory layouts MUST adopt hashbrown::HashTable as the underlying low-level hash table data structure.

## Policy Block

- MUST Internal runtime modules requiring direct bucket manipulation or specialized memory layouts MUST adopt hashbrown::HashTable as the underlying low-level hash table data structure.

...
1. MUST: All type construction, dataclass adaptation, and schema generation routines MUST utilize DecoratorInfos.build to extract, validate, and collect decorator metadata from target class namespaces.

## Policy Block

- MUST All type construction, dataclass adaptation, and schema generation routines MUST utilize DecoratorInfos.build to extract, validate, and collect decorator metadata from target class namespaces.

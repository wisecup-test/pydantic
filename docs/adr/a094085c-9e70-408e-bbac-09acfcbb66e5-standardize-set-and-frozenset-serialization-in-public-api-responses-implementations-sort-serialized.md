...
1. MAY: Implementations MAY sort serialized set elements for deterministic output if performance requirements permit

## Policy Block

- MAY Implementations MAY sort serialized set elements for deterministic output if performance requirements permit

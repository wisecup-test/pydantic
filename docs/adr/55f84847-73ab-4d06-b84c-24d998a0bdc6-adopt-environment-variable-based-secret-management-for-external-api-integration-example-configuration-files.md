# Adopt Environment Variable-Based Secret Management for External API Integration: Example Configuration Files
...
1. SHOULD: Example configuration files (.env.example) SHOULD be provided with placeholder values for required API credentials

## Policy Block

- SHOULD Example configuration files (.env.example) SHOULD be provided with placeholder values for required API credentials

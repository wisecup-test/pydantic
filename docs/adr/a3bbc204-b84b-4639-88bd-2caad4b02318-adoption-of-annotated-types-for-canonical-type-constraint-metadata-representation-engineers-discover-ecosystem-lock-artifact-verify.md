...
1. MUST: Engineers MUST discover the ecosystem lock artifact and verify the exact resolved version of `annotated_types` before declaring new metadata integrations.

## Policy Block

- MUST Engineers MUST discover the ecosystem lock artifact and verify the exact resolved version of `annotated_types` before declaring new metadata integrations.

...
1. MUST: Type serializers that support recursive or shared definition references MUST register and query definition identifiers through DefinitionsBuilder rather than managing standalone definition registries.

## Policy Block

- MUST Type serializers that support recursive or shared definition references MUST register and query definition identifiers through DefinitionsBuilder rather than managing standalone definition registries.

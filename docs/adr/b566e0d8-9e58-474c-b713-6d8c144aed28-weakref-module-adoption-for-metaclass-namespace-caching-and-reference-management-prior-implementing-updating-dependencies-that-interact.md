...
1. MUST: Prior to implementing or updating dependencies that interact with runtime reference lifecycles, developers MUST consult the repository dependency manifest and authoritative lock resolution artifact to verify resolved environment constraints.

## Policy Block

- MUST Prior to implementing or updating dependencies that interact with runtime reference lifecycles, developers MUST consult the repository dependency manifest and authoritative lock resolution artifact to verify resolved environment constraints.

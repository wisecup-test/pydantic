...
1. SHOULD: Documentation generation tools and plugins SHOULD include integration tests to verify correct interaction with the main codebase

## Policy Block

- SHOULD Documentation generation tools and plugins SHOULD include integration tests to verify correct interaction with the main codebase

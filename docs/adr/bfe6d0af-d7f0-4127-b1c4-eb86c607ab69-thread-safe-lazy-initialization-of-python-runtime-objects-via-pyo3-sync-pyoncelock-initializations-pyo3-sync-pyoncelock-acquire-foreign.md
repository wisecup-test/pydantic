...
1. MUST: Initializations using pyo3::sync::PyOnceLock MUST acquire the foreign runtime interpreter context through standard acquisition mechanisms before evaluating the initialization closure.

## Policy Block

- MUST Initializations using pyo3::sync::PyOnceLock MUST acquire the foreign runtime interpreter context through standard acquisition mechanisms before evaluating the initialization closure.

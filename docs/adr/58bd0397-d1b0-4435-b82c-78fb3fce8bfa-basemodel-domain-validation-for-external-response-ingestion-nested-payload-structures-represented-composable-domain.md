...
1. MUST: Nested payload structures MUST be represented as composable domain model classes rather than unstructured associative mappings.

## Policy Block

- MUST Nested payload structures MUST be represented as composable domain model classes rather than unstructured associative mappings.

...
1. MUST: Operational scripts MUST record serialized configuration states using logging.info during initialization.

## Policy Block

- MUST Operational scripts MUST record serialized configuration states using logging.info during initialization.

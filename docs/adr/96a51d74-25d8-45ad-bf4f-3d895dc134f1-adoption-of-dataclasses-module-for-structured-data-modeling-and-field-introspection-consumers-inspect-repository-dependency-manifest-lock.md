...
1. MUST: Consumers MUST inspect the repository dependency manifest and lock artifacts to determine resolved runtime versions before applying dataclass reflection APIs.

## Policy Block

- MUST Consumers MUST inspect the repository dependency manifest and lock artifacts to determine resolved runtime versions before applying dataclass reflection APIs.

...
1. SHOULD: String inputs requiring zero-copy extraction across the boundary SHOULD utilize pyo3::pybacked::PyBackedStr where lifetime preservation without copying is supported.

## Policy Block

- SHOULD String inputs requiring zero-copy extraction across the boundary SHOULD utilize pyo3::pybacked::PyBackedStr where lifetime preservation without copying is supported.

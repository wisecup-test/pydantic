# Enforce Domain Validation in Public API Models: Domain Validation Rules
...
1. SHOULD: Domain validation rules SHOULD be co-located with model definitions to maintain clear ownership and discoverability

## Policy Block

- SHOULD Domain validation rules SHOULD be co-located with model definitions to maintain clear ownership and discoverability

...
1. MUST_NOT: Plugin implementations MUST NOT hardcode external service credentials or commit environment-specific configuration values to static document tree definitions.

## Policy Block

- MUST_NOT Plugin implementations MUST NOT hardcode external service credentials or commit environment-specific configuration values to static document tree definitions.

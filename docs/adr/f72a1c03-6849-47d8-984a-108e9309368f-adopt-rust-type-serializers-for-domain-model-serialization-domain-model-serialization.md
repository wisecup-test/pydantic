...
1. MUST: Domain model serialization MUST be implemented using dedicated Rust type serializers in the pydantic-core serializers/type_serializers directory

## Policy Block

- MUST Domain model serialization MUST be implemented using dedicated Rust type serializers in the pydantic-core serializers/type_serializers directory

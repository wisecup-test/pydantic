...
1. MAY: Tests MAY use helper functions or test utilities to reduce duplication across similar serializer test suites

## Policy Block

- MAY Tests MAY use helper functions or test utilities to reduce duplication across similar serializer test suites

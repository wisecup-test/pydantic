...
1. MUST: Sentinel value serializers (missing, undefined) MUST distinguish between explicit None values and absent/undefined values in serialization output

## Policy Block

- MUST Sentinel value serializers (missing, undefined) MUST distinguish between explicit None values and absent/undefined values in serialization output

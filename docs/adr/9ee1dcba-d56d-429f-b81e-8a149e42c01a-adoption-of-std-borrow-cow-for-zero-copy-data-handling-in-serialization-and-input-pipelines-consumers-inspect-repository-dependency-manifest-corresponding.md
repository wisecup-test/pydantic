...
1. MUST: Consumers MUST inspect the repository dependency manifest and corresponding lock artifact to verify compiler and library compatibility before implementing or modifying routines using borrowed container patterns.

## Policy Block

- MUST Consumers MUST inspect the repository dependency manifest and corresponding lock artifact to verify compiler and library compatibility before implementing or modifying routines using borrowed container patterns.

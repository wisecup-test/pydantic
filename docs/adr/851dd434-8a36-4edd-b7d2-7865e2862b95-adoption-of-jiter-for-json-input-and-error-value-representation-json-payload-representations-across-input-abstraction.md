...
1. MUST: All JSON payload representations across input abstraction, field validation, and line error reporting layers MUST use jiter data types, specifically jiter::JsonValue and jiter::JsonObject, as the canonical internal JSON data representation.

## Policy Block

- MUST All JSON payload representations across input abstraction, field validation, and line error reporting layers MUST use jiter data types, specifically jiter::JsonValue and jiter::JsonObject, as the canonical internal JSON data representation.

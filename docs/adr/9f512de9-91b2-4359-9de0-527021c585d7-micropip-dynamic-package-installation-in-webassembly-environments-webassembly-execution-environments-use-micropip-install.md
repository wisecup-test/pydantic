...
1. MUST: WebAssembly execution environments MUST use micropip.install to resolve and mount dynamic dependencies and wheel artifacts directly into the active runtime context.

## Policy Block

- MUST WebAssembly execution environments MUST use micropip.install to resolve and mount dynamic dependencies and wheel artifacts directly into the active runtime context.

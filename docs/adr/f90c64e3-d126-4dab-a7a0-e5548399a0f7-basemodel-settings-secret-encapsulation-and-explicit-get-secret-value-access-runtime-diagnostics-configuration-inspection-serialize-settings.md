...
1. SHOULD: Runtime diagnostics and configuration inspection SHOULD serialize settings exclusively via model_dump_json to guarantee automated secret masking across all log sinks.

## Policy Block

- SHOULD Runtime diagnostics and configuration inspection SHOULD serialize settings exclusively via model_dump_json to guarantee automated secret masking across all log sinks.

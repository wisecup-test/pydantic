...
1. MUST: Custom serialization routines MUST construct serialization errors using the custom method of the serde::ser::Error trait when translating internal or domain-specific failure conditions.

## Policy Block

- MUST Custom serialization routines MUST construct serialization errors using the custom method of the serde::ser::Error trait when translating internal or domain-specific failure conditions.

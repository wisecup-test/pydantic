...
1. MAY: Validation components MAY utilize borrowed variants of jiter data structures to avoid heap allocations when input lifetimes allow.

## Policy Block

- MAY Validation components MAY utilize borrowed variants of jiter data structures to avoid heap allocations when input lifetimes allow.

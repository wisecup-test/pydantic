...
1. MUST: Native traversal implementations MUST propagate visitor callback errors immediately by returning pyo3::PyTraverseError to the calling runtime traversal routine.

## Policy Block

- MUST Native traversal implementations MUST propagate visitor callback errors immediately by returning pyo3::PyTraverseError to the calling runtime traversal routine.

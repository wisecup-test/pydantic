# Standardize Python-Rust FFI Boundary with PyO3 for External API Validation: Python Exposed Rust
...
1. MUST: All Python-exposed Rust types MUST use PyO3 derive macros (#[pyclass], #[pymethods]) to ensure type-safe FFI bindings

## Policy Block

- MUST All Python-exposed Rust types MUST use PyO3 derive macros (#[pyclass], #[pymethods]) to ensure type-safe FFI bindings

...
1. MUST: Enumeration members MUST define string values matching their designated domain representations to ensure transparent string serialization and backward compatibility.

## Policy Block

- MUST Enumeration members MUST define string values matching their designated domain representations to ensure transparent string serialization and backward compatibility.

...
1. MUST: Internal schema generation and serialization subsystems MUST delegate core validation and serialization execution to pydantic_core interfaces and data representations.

## Policy Block

- MUST Internal schema generation and serialization subsystems MUST delegate core validation and serialization execution to pydantic_core interfaces and data representations.

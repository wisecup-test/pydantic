# Adopt pytest as Standard Testing Framework for Python Projects: Tests Utilize Pytest
...
1. SHOULD: Tests SHOULD utilize pytest fixtures for setup and teardown operations to promote code reuse and maintainability

## Policy Block

- SHOULD Tests SHOULD utilize pytest fixtures for setup and teardown operations to promote code reuse and maintainability

...
1. MUST: Engineers MUST verify external dependency compatibility against the project dependency lock artifact before introducing or modifying typing shims to ensure aligned interface expectations.

## Policy Block

- MUST Engineers MUST verify external dependency compatibility against the project dependency lock artifact before introducing or modifying typing shims to ensure aligned interface expectations.

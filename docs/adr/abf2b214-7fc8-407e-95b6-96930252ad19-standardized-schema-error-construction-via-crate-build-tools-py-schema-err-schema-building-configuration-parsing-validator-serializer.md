...
1. MUST: Schema building, configuration parsing, and validator or serializer construction routines MUST use crate::build_tools::py_schema_err to construct and return errors whenever an invalid schema definition or unsupported configuration is detected.

## Policy Block

- MUST Schema building, configuration parsing, and validator or serializer construction routines MUST use crate::build_tools::py_schema_err to construct and return errors whenever an invalid schema definition or unsupported configuration is detected.

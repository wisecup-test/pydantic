# Implement Cache Layer for External API Data Validation: Cache Implementations Use
...
1. SHOULD: Cache implementations SHOULD use TTL (time-to-live) expiration policies appropriate to the data type being validated (e.g., shorter TTLs for DNS-based validations)

## Policy Block

- SHOULD Cache implementations SHOULD use TTL (time-to-live) expiration policies appropriate to the data type being validated (e.g., shorter TTLs for DNS-based validations)

# Establish Public API Contracts for Design System Components: Breaking Changes Public
...
1. SHOULD: Breaking changes to public contracts SHOULD be deprecated with migration paths before removal in subsequent major versions

## Policy Block

- SHOULD Breaking changes to public contracts SHOULD be deprecated with migration paths before removal in subsequent major versions

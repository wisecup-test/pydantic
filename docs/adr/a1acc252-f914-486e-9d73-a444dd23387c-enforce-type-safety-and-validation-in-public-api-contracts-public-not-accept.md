# Enforce Type Safety and Validation in Public API Contracts: Public Not Accept
...
1. MUST_NOT: Public APIs MUST NOT accept unvalidated or loosely-typed inputs (e.g., Any, dict without schema) from external sources

## Policy Block

- MUST_NOT Public APIs MUST NOT accept unvalidated or loosely-typed inputs (e.g., Any, dict without schema) from external sources

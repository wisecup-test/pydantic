# Standardize Pytest-Based Validator Testing in CI/CD Pipeline: Test Files Executed
...
1. MUST: Test files MUST be executed as part of the CI/CD pipeline before any deployment or merge to main branch

## Policy Block

- MUST Test files MUST be executed as part of the CI/CD pipeline before any deployment or merge to main branch

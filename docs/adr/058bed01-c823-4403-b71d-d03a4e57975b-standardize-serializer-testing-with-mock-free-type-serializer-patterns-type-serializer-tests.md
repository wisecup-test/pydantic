...
1. MUST_NOT: Type serializer tests MUST NOT introduce dependencies on external mocking frameworks that could create test brittleness or maintenance burden

## Policy Block

- MUST_NOT Type serializer tests MUST NOT introduce dependencies on external mocking frameworks that could create test brittleness or maintenance burden

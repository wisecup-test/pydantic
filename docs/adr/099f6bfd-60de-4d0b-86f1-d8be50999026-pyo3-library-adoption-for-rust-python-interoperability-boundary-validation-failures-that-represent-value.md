...
1. MUST: Boundary validation failures that represent value errors MUST propagate across the foreign-function interface as pyo3::exceptions::PyValueError rather than causing native panic or silent truncation.

## Policy Block

- MUST Boundary validation failures that represent value errors MUST propagate across the foreign-function interface as pyo3::exceptions::PyValueError rather than causing native panic or silent truncation.

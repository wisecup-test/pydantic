...
1. MAY: Internal caching layers MAY store transient type evaluation metadata in weak-key or weak-value containers when metadata lifetime must mirror target class lifetime.

## Policy Block

- MAY Internal caching layers MAY store transient type evaluation metadata in weak-key or weak-value containers when metadata lifetime must mirror target class lifetime.

...
1. MUST: Error reporting structures capturing invalid JSON values MUST store line-level error contexts using jiter::JsonValue representations to preserve input fidelity.

## Policy Block

- MUST Error reporting structures capturing invalid JSON values MUST store line-level error contexts using jiter::JsonValue representations to preserve input fidelity.

# Standardize Testing Fixtures for Public API Validation: Fixtures Organized Functional
...
1. SHOULD: Fixtures SHOULD be organized by functional domain (networks, schema generation, model construction) to improve maintainability

## Policy Block

- SHOULD Fixtures SHOULD be organized by functional domain (networks, schema generation, model construction) to improve maintainability

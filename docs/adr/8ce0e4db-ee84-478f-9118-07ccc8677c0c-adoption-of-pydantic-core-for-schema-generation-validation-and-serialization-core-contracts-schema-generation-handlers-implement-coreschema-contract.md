...
1. MUST: Schema generation handlers MUST implement the CoreSchema contract conventions and resolve reference definitions through designated schema reference resolution methods when handling definition reference structures.

## Policy Block

- MUST Schema generation handlers MUST implement the CoreSchema contract conventions and resolve reference definitions through designated schema reference resolution methods when handling definition reference structures.

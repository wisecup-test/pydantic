...
1. MUST: Type serializer tests MUST use direct instantiation of serializer types rather than mock objects or test doubles

## Policy Block

- MUST Type serializer tests MUST use direct instantiation of serializer types rather than mock objects or test doubles

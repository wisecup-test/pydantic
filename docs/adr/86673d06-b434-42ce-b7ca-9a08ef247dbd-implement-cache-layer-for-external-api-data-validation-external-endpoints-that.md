# Implement Cache Layer for External API Data Validation: External Endpoints That
...
1. MUST: External API endpoints that validate network data types (URLs, email addresses, IP addresses, domains) MUST implement a cache layer for validation results

## Policy Block

- MUST External API endpoints that validate network data types (URLs, email addresses, IP addresses, domains) MUST implement a cache layer for validation results

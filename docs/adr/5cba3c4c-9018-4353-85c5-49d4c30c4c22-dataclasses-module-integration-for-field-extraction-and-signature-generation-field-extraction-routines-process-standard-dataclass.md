...
1. MUST: Field extraction routines MUST process standard dataclass structures through collect_dataclass_fields while routing model definitions through collect_model_fields to isolate dataclass semantics from model field configuration.

## Policy Block

- MUST Field extraction routines MUST process standard dataclass structures through collect_dataclass_fields while routing model definitions through collect_model_fields to isolate dataclass semantics from model field configuration.

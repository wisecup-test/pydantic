# Adopt Pydantic V1 Compatibility Layer for Type Validation: New Code Use
...
1. SHOULD: New code SHOULD use Pydantic V2 APIs (TypeAdapter, JSON schema generation) unless V1 compatibility is explicitly required

## Policy Block

- SHOULD New code SHOULD use Pydantic V2 APIs (TypeAdapter, JSON schema generation) unless V1 compatibility is explicitly required

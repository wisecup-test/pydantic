...
1. MUST: Field definition constructors accepting constraint parameters MUST map boundary criteria directly to corresponding `annotated_types` descriptors in internal metadata lookups.

## Policy Block

- MUST Field definition constructors accepting constraint parameters MUST map boundary criteria directly to corresponding `annotated_types` descriptors in internal metadata lookups.

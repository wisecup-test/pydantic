# Adopt pytest as Standard Testing Framework for Python Projects: Test Functions Prefixed
...
1. MUST: All test functions MUST be prefixed with 'test_' to enable automatic test discovery by pytest

## Policy Block

- MUST All test functions MUST be prefixed with 'test_' to enable automatic test discovery by pytest

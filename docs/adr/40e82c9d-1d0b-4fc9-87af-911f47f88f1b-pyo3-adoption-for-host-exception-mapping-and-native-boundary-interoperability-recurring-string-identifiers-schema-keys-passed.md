...
1. MUST: Recurring string identifiers and schema keys passed across the boundary MUST utilize pyo3::intern to avoid duplicate object allocations in the host runtime.

## Policy Block

- MUST Recurring string identifiers and schema keys passed across the boundary MUST utilize pyo3::intern to avoid duplicate object allocations in the host runtime.

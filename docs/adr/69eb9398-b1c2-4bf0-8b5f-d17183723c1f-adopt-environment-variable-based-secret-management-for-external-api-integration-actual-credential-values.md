# Adopt Environment Variable-Based Secret Management for External API Integration: Actual Credential Values
...
1. MUST_NOT: Actual credential values MUST NOT be committed to version control, and .env files containing real secrets MUST be excluded via .gitignore

## Policy Block

- MUST_NOT Actual credential values MUST NOT be committed to version control, and .env files containing real secrets MUST be excluded via .gitignore

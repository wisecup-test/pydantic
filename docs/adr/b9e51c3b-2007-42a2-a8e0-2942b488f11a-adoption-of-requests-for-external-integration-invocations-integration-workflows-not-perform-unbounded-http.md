...
1. SHOULD_NOT: Integration workflows SHOULD NOT perform unbounded HTTP requests without configured request timeout parameters.

## Policy Block

- SHOULD_NOT Integration workflows SHOULD NOT perform unbounded HTTP requests without configured request timeout parameters.

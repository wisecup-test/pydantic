...
1. SHOULD: Serialized set and frozenset arrays SHOULD maintain element uniqueness constraints during validation

## Policy Block

- SHOULD Serialized set and frozenset arrays SHOULD maintain element uniqueness constraints during validation

# Enforce Type Safety and Validation in Public API Contracts: Public Use Root
...
1. SHOULD: Public APIs SHOULD use root models or custom validators when complex validation logic beyond basic type checking is required

## Policy Block

- SHOULD Public APIs SHOULD use root models or custom validators when complex validation logic beyond basic type checking is required

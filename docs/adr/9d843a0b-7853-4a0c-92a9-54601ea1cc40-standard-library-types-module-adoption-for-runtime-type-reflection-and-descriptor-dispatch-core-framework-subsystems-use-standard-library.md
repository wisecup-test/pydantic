...
1. MUST: Core framework subsystems MUST use the standard library types module for runtime type reflection, dynamic function introspection, and descriptor proxying rather than relying on external reflection libraries or arbitrary string evaluations.

## Policy Block

- MUST Core framework subsystems MUST use the standard library types module for runtime type reflection, dynamic function introspection, and descriptor proxying rather than relying on external reflection libraries or arbitrary string evaluations.

...
1. SHOULD: Conversions of native return values to Python runtime objects SHOULD use pyo3::IntoPyObjectExt to minimize conversion overhead and maintain ownership transfer semantics.

## Policy Block

- SHOULD Conversions of native return values to Python runtime objects SHOULD use pyo3::IntoPyObjectExt to minimize conversion overhead and maintain ownership transfer semantics.

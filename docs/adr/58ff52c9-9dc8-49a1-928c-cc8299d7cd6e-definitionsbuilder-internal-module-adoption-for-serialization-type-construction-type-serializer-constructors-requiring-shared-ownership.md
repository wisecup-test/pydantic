...
1. MUST: Type serializer constructors requiring shared ownership of compiled sub-serializers MUST store resolved definitions behind thread-safe reference-counted pointers.

## Policy Block

- MUST Type serializer constructors requiring shared ownership of compiled sub-serializers MUST store resolved definitions behind thread-safe reference-counted pointers.

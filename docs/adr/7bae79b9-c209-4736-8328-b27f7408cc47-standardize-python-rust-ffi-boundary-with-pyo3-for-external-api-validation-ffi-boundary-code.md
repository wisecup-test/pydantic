# Standardize Python-Rust FFI Boundary with PyO3 for External API Validation: Ffi Boundary Code
...
1. MUST: All FFI boundary code MUST support mocking and testing through Python's standard testing frameworks

## Policy Block

- MUST All FFI boundary code MUST support mocking and testing through Python's standard testing frameworks

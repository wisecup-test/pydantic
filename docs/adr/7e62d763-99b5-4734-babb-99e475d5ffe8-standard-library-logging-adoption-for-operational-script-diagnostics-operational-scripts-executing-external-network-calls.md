...
1. MUST: Operational scripts executing external network calls MUST record non-200 HTTP responses and response error payloads using logging.error with relevant contextual parameters.

## Policy Block

- MUST Operational scripts executing external network calls MUST record non-200 HTTP responses and response error payloads using logging.error with relevant contextual parameters.

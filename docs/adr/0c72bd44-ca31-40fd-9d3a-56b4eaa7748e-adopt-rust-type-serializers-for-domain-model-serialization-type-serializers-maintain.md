...
1. SHOULD: Type serializers SHOULD maintain separation of concerns between domain model definitions and serialization logic

## Policy Block

- SHOULD Type serializers SHOULD maintain separation of concerns between domain model definitions and serialization logic

# Enforce Domain Validation in Public API Models: Models Use Type
...
1. MUST: API models MUST use type annotations and validation frameworks (e.g., Pydantic, dataclasses with validators) to enforce data contracts

## Policy Block

- MUST API models MUST use type annotations and validation frameworks (e.g., Pydantic, dataclasses with validators) to enforce data contracts

...
1. MUST: Consumers MUST discover the ecosystem lock file and verify the exact locked version of data modeling dependencies before implementing or modifying data model schemas.

## Policy Block

- MUST Consumers MUST discover the ecosystem lock file and verify the exact locked version of data modeling dependencies before implementing or modifying data model schemas.

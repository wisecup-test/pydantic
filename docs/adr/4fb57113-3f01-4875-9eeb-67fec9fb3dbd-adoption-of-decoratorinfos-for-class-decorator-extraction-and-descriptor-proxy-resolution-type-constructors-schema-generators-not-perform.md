...
1. MUST_NOT: Type constructors and schema generators MUST_NOT perform ad-hoc inspection of class attribute dictionaries or bypass DecoratorInfos when resolving descriptor proxies and wrapped methods.

## Policy Block

- MUST_NOT Type constructors and schema generators MUST_NOT perform ad-hoc inspection of class attribute dictionaries or bypass DecoratorInfos when resolving descriptor proxies and wrapped methods.

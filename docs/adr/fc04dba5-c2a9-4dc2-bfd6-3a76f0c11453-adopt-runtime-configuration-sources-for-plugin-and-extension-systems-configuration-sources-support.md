# Adopt Runtime Configuration Sources for Plugin and Extension Systems: Configuration Sources Support
...
1. SHOULD: Configuration sources SHOULD support multiple formats (environment variables, JSON, YAML, TOML) to accommodate different deployment scenarios

## Policy Block

- SHOULD Configuration sources SHOULD support multiple formats (environment variables, JSON, YAML, TOML) to accommodate different deployment scenarios

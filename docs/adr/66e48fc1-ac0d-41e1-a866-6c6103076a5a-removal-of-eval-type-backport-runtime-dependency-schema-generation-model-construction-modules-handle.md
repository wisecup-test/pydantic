...
1. MUST: Schema generation and model construction modules MUST handle forward reference evaluation exclusively through internal typing resolution routines.

## Policy Block

- MUST Schema generation and model construction modules MUST handle forward reference evaluation exclusively through internal typing resolution routines.

# collections.abc Mapping Protocol Adoption for Namespace and Configuration Resolution: Custom Mapping Implementations Fulfill Abstract Methods
...
1. MUST: Custom mapping implementations MUST fulfill all abstract methods of the collections.abc.Mapping protocol, including item lookup, length calculation, container membership testing, and iteration.

## Policy Block

- MUST Custom mapping implementations MUST fulfill all abstract methods of the collections.abc.Mapping protocol, including item lookup, length calculation, container membership testing, and iteration.

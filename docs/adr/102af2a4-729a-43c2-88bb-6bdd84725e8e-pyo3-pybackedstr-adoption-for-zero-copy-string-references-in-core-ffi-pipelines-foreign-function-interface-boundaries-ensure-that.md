...
1. MUST: Foreign function interface boundaries MUST ensure that foreign runtime object lifetimes backing pyo3::pybacked::PyBackedStr instances are preserved for the entire duration of the reference usage.

## Policy Block

- MUST Foreign function interface boundaries MUST ensure that foreign runtime object lifetimes backing pyo3::pybacked::PyBackedStr instances are preserved for the entire duration of the reference usage.

# Adopt Type Annotation and Runtime Validation for Public API Interfaces: Public Documentation Include
...
1. SHOULD: Public API documentation SHOULD include type signature examples and validation behavior descriptions

## Policy Block

- SHOULD Public API documentation SHOULD include type signature examples and validation behavior descriptions

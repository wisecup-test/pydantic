...
1. MUST: All public API serialization MUST be implemented through dedicated type-specific serializer modules

## Policy Block

- MUST All public API serialization MUST be implemented through dedicated type-specific serializer modules

...
1. SHOULD: Serialization state containers and context wrappers SHOULD integrate custom error creation helpers that map runtime type mismatches and sentinel omissions directly to serde::ser::Error conforming structures.

## Policy Block

- SHOULD Serialization state containers and context wrappers SHOULD integrate custom error creation helpers that map runtime type mismatches and sentinel omissions directly to serde::ser::Error conforming structures.

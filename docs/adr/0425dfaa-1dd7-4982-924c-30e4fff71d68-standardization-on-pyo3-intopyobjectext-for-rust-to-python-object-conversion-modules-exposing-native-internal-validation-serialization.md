...
1. MUST: Modules exposing native internal validation or serialization structures across the foreign function interface boundary MUST convert values into foreign runtime representations using the pyo3::IntoPyObjectExt trait.

## Policy Block

- MUST Modules exposing native internal validation or serialization structures across the foreign function interface boundary MUST convert values into foreign runtime representations using the pyo3::IntoPyObjectExt trait.

...
1. MUST_NOT: Native modules MUST NOT perform repeated dynamic module imports or type resolutions within hot validation or serialization paths when the target type can be cached via pyo3::sync::PyOnceLock.

## Policy Block

- MUST_NOT Native modules MUST NOT perform repeated dynamic module imports or type resolutions within hot validation or serialization paths when the target type can be cached via pyo3::sync::PyOnceLock.

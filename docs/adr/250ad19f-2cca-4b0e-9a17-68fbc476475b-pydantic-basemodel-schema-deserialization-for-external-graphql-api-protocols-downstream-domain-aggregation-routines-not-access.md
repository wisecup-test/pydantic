...
1. MUST_NOT: Downstream domain aggregation routines MUST NOT access raw response dictionaries directly when structured BaseModel schemas are defined for the corresponding API protocol.

## Policy Block

- MUST_NOT Downstream domain aggregation routines MUST NOT access raw response dictionaries directly when structured BaseModel schemas are defined for the corresponding API protocol.

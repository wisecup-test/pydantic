...
1. MUST_NOT: Builder routines MUST NOT construct ad-hoc exception instances or return runtime validation error types for errors occurring during schema compilation and configuration parsing.

## Policy Block

- MUST_NOT Builder routines MUST NOT construct ad-hoc exception instances or return runtime validation error types for errors occurring during schema compilation and configuration parsing.

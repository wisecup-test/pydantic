...
1. MUST: Consumers MUST inspect the repository dependency manifest and authoritative lock artifact to resolve the exact locked version of the core validation library before compiling or referencing core schema definitions.

## Policy Block

- MUST Consumers MUST inspect the repository dependency manifest and authoritative lock artifact to resolve the exact locked version of the core validation library before compiling or referencing core schema definitions.

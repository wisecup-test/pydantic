...
1. MUST_NOT: Namespace resolution routines MUST NOT mutate passed parent or global namespaces when constructing composite evaluation contexts.

## Policy Block

- MUST_NOT Namespace resolution routines MUST NOT mutate passed parent or global namespaces when constructing composite evaluation contexts.

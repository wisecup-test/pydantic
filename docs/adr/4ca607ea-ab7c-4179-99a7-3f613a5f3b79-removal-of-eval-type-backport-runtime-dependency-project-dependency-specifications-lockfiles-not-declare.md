...
1. MUST_NOT: Project dependency specifications and lockfiles MUST NOT declare eval_type_backport as a runtime dependency.

## Policy Block

- MUST_NOT Project dependency specifications and lockfiles MUST NOT declare eval_type_backport as a runtime dependency.

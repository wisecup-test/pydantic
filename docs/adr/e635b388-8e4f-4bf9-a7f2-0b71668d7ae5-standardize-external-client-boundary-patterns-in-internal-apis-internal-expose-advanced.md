...
1. MAY: Internal APIs MAY expose advanced interfaces for power users through explicitly documented extension points with stability warnings

## Policy Block

- MAY Internal APIs MAY expose advanced interfaces for power users through explicitly documented extension points with stability warnings

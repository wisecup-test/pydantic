...
1. MAY: Type serializers MAY implement performance optimizations specific to their domain type characteristics

## Policy Block

- MAY Type serializers MAY implement performance optimizations specific to their domain type characteristics

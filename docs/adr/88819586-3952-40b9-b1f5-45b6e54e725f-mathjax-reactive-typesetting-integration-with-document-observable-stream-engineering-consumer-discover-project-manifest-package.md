...
1. MUST: The engineering consumer MUST discover the project manifest and package resolution lock artifact to verify the exact resolved version of the MathJax runtime before authoring or modifying typesetting lifecycle hooks.

## Policy Block

- MUST The engineering consumer MUST discover the project manifest and package resolution lock artifact to verify the exact resolved version of the MathJax runtime before authoring or modifying typesetting lifecycle hooks.

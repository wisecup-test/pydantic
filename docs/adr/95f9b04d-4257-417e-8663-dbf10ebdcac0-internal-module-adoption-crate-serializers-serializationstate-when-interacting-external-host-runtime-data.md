...
1. MUST: When interacting with external or host runtime data types, serializer routines MUST resolve and verify the active dependency lock artifact in the project repository to bind exact dependency interfaces before invoking third-party integration points.

## Policy Block

- MUST When interacting with external or host runtime data types, serializer routines MUST resolve and verify the active dependency lock artifact in the project repository to bind exact dependency interfaces before invoking third-party integration points.

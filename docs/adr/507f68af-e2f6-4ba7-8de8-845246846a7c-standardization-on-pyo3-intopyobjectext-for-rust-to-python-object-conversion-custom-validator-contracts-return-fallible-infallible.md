...
1. MAY: Custom validator contracts MAY return Fallible or Infallible conversion representations when mapping intermediate native errors directly into foreign exception types.

## Policy Block

- MAY Custom validator contracts MAY return Fallible or Infallible conversion representations when mapping intermediate native errors directly into foreign exception types.

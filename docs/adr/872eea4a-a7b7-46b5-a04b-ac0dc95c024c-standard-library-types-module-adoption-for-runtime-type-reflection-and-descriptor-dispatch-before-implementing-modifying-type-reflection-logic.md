...
1. MUST: Before implementing or modifying type reflection logic involving external dependencies, developers MUST discover the dependency manifest and authoritative lock artifact in the project repository to verify resolved library versions against official documentation.

## Policy Block

- MUST Before implementing or modifying type reflection logic involving external dependencies, developers MUST discover the dependency manifest and authoritative lock artifact in the project repository to verify resolved library versions against official documentation.

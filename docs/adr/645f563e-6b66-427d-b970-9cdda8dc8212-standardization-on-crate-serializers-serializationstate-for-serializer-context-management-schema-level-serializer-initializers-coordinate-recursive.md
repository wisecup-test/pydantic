...
1. SHOULD: Schema-level serializer initializers SHOULD coordinate recursive type resolution and reference tracking using DefinitionsBuilder in conjunction with crate::serializers::SerializationState.

## Policy Block

- SHOULD Schema-level serializer initializers SHOULD coordinate recursive type resolution and reference tracking using DefinitionsBuilder in conjunction with crate::serializers::SerializationState.

...
1. MUST: Prior to implementing or updating lifecycle hook dependencies, consumers MUST inspect the project lock artifact to resolve the authoritative locked version and verify public API compatibility.

## Policy Block

- MUST Prior to implementing or updating lifecycle hook dependencies, consumers MUST inspect the project lock artifact to resolve the authoritative locked version and verify public API compatibility.

# Standardize Python-Rust FFI Boundary with PyO3 for External API Validation: Serializers Use Prebuilt
...
1. SHOULD: Serializers SHOULD use prebuilt type serializers with object type detection (ob_type) for performance optimization

## Policy Block

- SHOULD Serializers SHOULD use prebuilt type serializers with object type detection (ob_type) for performance optimization

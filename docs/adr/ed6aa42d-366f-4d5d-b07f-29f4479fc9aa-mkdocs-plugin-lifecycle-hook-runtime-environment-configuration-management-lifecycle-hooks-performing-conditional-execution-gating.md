...
1. MUST: Lifecycle hooks performing conditional execution gating or remote publishing MUST evaluate runtime environment flags using getenv lookups to gracefully bypass sensitive operations during local execution contexts.

## Policy Block

- MUST Lifecycle hooks performing conditional execution gating or remote publishing MUST evaluate runtime environment flags using getenv lookups to gracefully bypass sensitive operations during local execution contexts.

...
1. MUST: Core internal data structures requiring associative key-value mapping, definition caches, validation lookup trees, and serialization field registries MUST use ahash::AHashMap rather than default standard library hash maps.

## Policy Block

- MUST Core internal data structures requiring associative key-value mapping, definition caches, validation lookup trees, and serialization field registries MUST use ahash::AHashMap rather than default standard library hash maps.

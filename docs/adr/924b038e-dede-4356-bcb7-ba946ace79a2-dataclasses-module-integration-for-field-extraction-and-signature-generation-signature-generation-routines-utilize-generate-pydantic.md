...
1. MUST: Signature generation routines MUST utilize generate_pydantic_signature and signature_no_eval to reflect dataclass parameter defaults, field aliases, and validation aliases without triggering premature annotation evaluation.

## Policy Block

- MUST Signature generation routines MUST utilize generate_pydantic_signature and signature_no_eval to reflect dataclass parameter defaults, field aliases, and validation aliases without triggering premature annotation evaluation.

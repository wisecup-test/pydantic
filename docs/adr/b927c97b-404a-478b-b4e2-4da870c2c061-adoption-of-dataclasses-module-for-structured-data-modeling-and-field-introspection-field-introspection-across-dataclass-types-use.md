...
1. MUST: Field introspection across dataclass types MUST use dedicated collector functions such as collect_dataclass_fields to normalize field attributes into unified field metadata structures.

## Policy Block

- MUST Field introspection across dataclass types MUST use dedicated collector functions such as collect_dataclass_fields to normalize field attributes into unified field metadata structures.

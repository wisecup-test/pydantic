...
1. MUST: All GitHub Actions workflows MUST undergo automated security linting enforced via zizmor.

## Policy Block

- MUST All GitHub Actions workflows MUST undergo automated security linting enforced via zizmor.

# Enforce Domain Validation in Public API Models: Validation Failures Return
...
1. MUST: Validation failures MUST return structured error responses with clear field-level error messages indicating which fields failed validation and why

## Policy Block

- MUST Validation failures MUST return structured error responses with clear field-level error messages indicating which fields failed validation and why

...
1. MUST: Errors constructed via crate::build_tools::py_schema_err MUST propagate as failed result types that map directly to the standardized schema error exception in the host runtime.

## Policy Block

- MUST Errors constructed via crate::build_tools::py_schema_err MUST propagate as failed result types that map directly to the standardized schema error exception in the host runtime.

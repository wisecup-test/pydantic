# Adopt Runtime Configuration Sources for Plugin and Extension Systems: Plugin Loaders Validate
...
1. SHOULD: Plugin loaders SHOULD validate configuration schemas at load time and fail fast with actionable error messages

## Policy Block

- SHOULD Plugin loaders SHOULD validate configuration schemas at load time and fail fast with actionable error messages

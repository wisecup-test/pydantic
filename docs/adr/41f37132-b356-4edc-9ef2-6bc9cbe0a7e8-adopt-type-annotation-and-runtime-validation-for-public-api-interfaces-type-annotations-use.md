# Adopt Type Annotation and Runtime Validation for Public API Interfaces: Type Annotations Use
...
1. MUST: Type annotations MUST use standard library types (typing module) and avoid framework-specific type extensions in public signatures

## Policy Block

- MUST Type annotations MUST use standard library types (typing module) and avoid framework-specific type extensions in public signatures

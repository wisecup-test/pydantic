...
1. MUST: Module initializers and runtime harnesses requiring dynamic export resolution or runtime module execution MUST use programmatic module loading via the importlib module instead of eager top-level static imports.

## Policy Block

- MUST Module initializers and runtime harnesses requiring dynamic export resolution or runtime module execution MUST use programmatic module loading via the importlib module instead of eager top-level static imports.

# Enforce Type Safety and Validation in Public API Contracts: Type Validation Errors
...
1. MUST: Type validation errors MUST provide clear, actionable error messages that specify the field name, expected type, and received value

## Policy Block

- MUST Type validation errors MUST provide clear, actionable error messages that specify the field name, expected type, and received value

...
1. MUST: Type introspection routines evaluating structured mappings MUST use is_typeddict and is_legacy_typeddict from the centralized typing module to resolve attribute requirements across supported runtime environments.

## Policy Block

- MUST Type introspection routines evaluating structured mappings MUST use is_typeddict and is_legacy_typeddict from the centralized typing module to resolve attribute requirements across supported runtime environments.

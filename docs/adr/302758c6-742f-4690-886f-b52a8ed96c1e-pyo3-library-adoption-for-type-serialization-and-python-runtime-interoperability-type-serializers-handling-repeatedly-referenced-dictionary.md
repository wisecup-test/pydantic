...
1. MUST: Type serializers handling repeatedly referenced dictionary keys and object attribute identifiers MUST use pyo3::intern to cache and reuse interned string references across serialization invocations.

## Policy Block

- MUST Type serializers handling repeatedly referenced dictionary keys and object attribute identifiers MUST use pyo3::intern to cache and reuse interned string references across serialization invocations.
